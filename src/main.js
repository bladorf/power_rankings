...
function ordinal_suffix_of(t) {
    ...
    K.fn = K.prototype = {
        ...
        var t, n, r, i, o, a, u = arguments[0] || {}, s = 1,
            c = arguments.length,
            l = !1;
    ...
    K.event = {
        ...
        fix: function(t) {
            ...
            var e, n, r = t,
                i = K.event.fixHooks[t.type] || {}, o = i.props ? this.props.concat(i.props) : this.props;
    ...
    Va.forEach(function(t, e) {
        ...
        var i = {}, o = ca.dispatch("progress", "load", "error"),
            a = {}, u = fe,
    ...
    ca.geom.hull = function(t) {
        ...
        function e(t) {
            ...
            if (s === jn && c === Fn) e = t;
                ...
                for (e = [], a = 0; l > a; ++a) e.push([+s.call(this, r = t[a], a), +c.call(this, r, a)]); if (ir(e, function(t) {
                var e, n, r, i, o, a;
    ...
    var zu = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g;
    ca.interpolate = yr, ca.interpolators = [
        function(t, e) {
            var n = typeof e;
    ...
    ca.ease = function(t) {
        ...
        var n, r, i, o, a, u = {}, s = ca.dispatch("start", "tick", "end"),
            c = [1, 1],
            l = .9,
            f = Iu,
            h = Wu,
        ...
        return u.tick = function() {
            ...
            if (i = [], "function" == typeof f)
                ...
                for (n = 0; g > n; ++n) i[n] = f; if (o = [], "function" == typeof h)
                for (n = 0; g > n; ++n) o[n] = +h.call(this, v[n], n);
            else
                for (n = 0; g > n; ++n) o[n] = h; if (a = [], "function" == typeof d)
...
function(t) {
    ...
    function o(t) {
        var e = this._data = {}, n = t.years || t.year || t.y || 0,
