/*! Twenty years of the English football league, visualised with D3.js:  2013-05-10 */
function highlightPath(t) {
  var e = d3.select('g.team.' + t) [0][0];
  e.parentNode.appendChild(e),
  d3.select('text.legend.' + t).transition().duration(200).style('font-weight', 'bold'),
  d3.select('path.inner[data-team="' + t + '"]').transition().duration(200).style('stroke-width', '4px').style('opacity', 0.9),
  d3.select('path.outer[data-team="' + t + '"]').transition().duration(200).style('stroke-opacity', 0.9)
}
function unHighlightPath(t) {
  d3.select('text.legend.' + t).transition().duration(200).style('font-weight', 'normal'),
  d3.select('path.inner[data-team="' + t + '"]').transition().duration(200).style('stroke-width', '2px').style('opacity', 0.7),
  d3.select('path.outer[data-team="' + t + '"]').transition().duration(200).style('stroke-opacity', 0)
}
...
function ordinal_suffix_of(t) {
  ...
  function i(t) {
    var e;
    for (e in t) if (('data' !== e || !K.isEmptyObject(t[e])) && 'toJSON' !== e) return !1;
    return !0
  }
  function o() {
    return !1
  ...
  function h(t, e) {
    if (1 === e.nodeType && K.hasData(t)) {
      ...
      if (u) {
        ...
        for (n in u) for (r = 0, i = u[n].length; i > r; r++) K.event.add(e, n, u[n][r])
      }
  ...
  function m(t, e) {
    if (e in t) return e;
    for (var n = e.charAt(0).toUpperCase() + e.slice(1), r = e, i = yn.length; i--; ) if (e = yn[i] + n, e in t) return e;
    return r
  }
  function v(t, e) {
    return t = e || t,
  ...
  function y(t, e) {
    for (var n, r, i = [
    ], o = 0, a = t.length; a > o; o++) n = t[o],
    n.style && (i[o] = K._data(n, 'olddisplay'), e ? (!i[o] && 'none' === n.style.display && (n.style.display = ''), '' === n.style.display && v(n) && (i[o] = K._data(n, 'olddisplay', _(n.nodeName))))  : (r = nn(n, 'display'), !i[o] && 'none' !== r && K._data(n, 'olddisplay', r)));
    for (o = 0; a > o; o++) n = t[o],
    n.style && (e && 'none' !== n.style.display && '' !== n.style.display || (n.style.display = e ? i[o] || '' : 'none'));
    return t
  }
  function x(t, e, n) {
    var r = fn.exec(e);
  ...
  function b(t, e, n, r) {
    for (var i = n === (r ? 'border' : 'content') ? 4 : 'width' === e ? 1 : 0, o = 0; 4 > i; i += 2) 'margin' === n && (o += K.css(t, n + vn[i], !0)),
    r ? ('content' === n && (o -= parseFloat(nn(t, 'padding' + vn[i])) || 0), 'margin' !== n && (o -= parseFloat(nn(t, 'border' + vn[i] + 'Width')) || 0))  : (o += parseFloat(nn(t, 'padding' + vn[i])) || 0, 'padding' !== n && (o += parseFloat(nn(t, 'border' + vn[i] + 'Width')) || 0));
    return o
  }
  function M(t, e, n) {
    ...
    if (0 >= r || null == r) {
      ...
      i = o && (K.support.boxSizingReliable || r === t.style[e]),
      r = parseFloat(r) || 0
    }
  ...
  function _(t) {
    ...
    ('none' === n || '' === n) && (rn = R.body.appendChild(rn || K.extend(R.createElement('iframe'), {
      ...
      width: 0,
      height: 0
    })), on && rn.createElement || (on = (rn.contentWindow || rn.contentDocument).document, on.write('<!doctype html><html><body>'), on.close()), e = on.body.appendChild(on.createElement(t)), n = nn(e, 'display'), R.body.removeChild(rn)),
    pn[t] = n,
    n
  }
  function w(t, e, n, r) {
  ...
  function k(t) {
    return function (e, n) {
      ...
      i,
      o,
      a = e.toLowerCase().split(ee),
      u = 0,
      s = a.length;
      if (K.isFunction(n)) for (; s > u; u++) r = a[u],
      o = /^\+/.test(r),
      o && (r = r.substr(1) || '*'),
      i = t[r] = t[r] || [],
      i[o ? 'unshift' : 'push'](n)
  ...
  function T(t, n, r, i, o, a) {
    ...
    a[o] = !0;
    for (var u, s = t[o], c = 0, l = s ? s.length : 0, f = t === On; l > c && (f || !u); c++) u = s[c](n, r, i),
    'string' == typeof u && (!f || a[u] ? u = e : (n.dataTypes.unshift(u), u = T(t, n, r, i, u, a)));
    return (f || !u) && !a['*'] && (u = T(t, n, r, i, '*', a)),
    u
  }
  function S(t, n) {
    var r,
  ...
  function N(t, e) {
    ...
    c = 0;
    if (t.dataFilter && (e = t.dataFilter(e, t.dataType)), a[1]) for (n in t.converters) s[n.toLowerCase()] = t.converters[n];
    for (; i = a[++c]; ) if ('*' !== i) {
      if ('*' !== u && u !== i) {
  ...
  function H(t, e, n) {
    ...
    c = s.props;
    for (j(c, s.opts.specialEasing); o > i; i++) if (r = Qn[i].call(s, t, c, s.opts)) return r;
    return L(s, c),
    K.isFunction(s.opts.start) && s.opts.start.call(t, s),
  ...
  function j(t, e) {
    ...
    o,
    a;
    for (n in t) if (r = K.camelCase(n), i = e[r], o = t[n], K.isArray(o) && (i = o[1], o = t[n] = o[0]), n !== r && (t[r] = o, delete t[n]), a = K.cssHooks[r], a && 'expand' in a) {
      o = a.expand(o),
      delete t[r];
  ...
  function F(t, e, n) {
    ...
    n.queue || (l = K._queueHooks(t, 'fx'), null == l.unqueued && (l.unqueued = 0, f = l.empty.fire, l.empty.fire = function () {
      ...
      h.always(function () {
        l.unqueued--,
        K.queue(t, 'fx').length || l.empty.fire()
      })
    })),
    1 === t.nodeType && ('height' in e || 'width' in e) && (n.overflow = [
      ...
      d.overflowX,
      d.overflowY
    ], 'inline' === K.css(t, 'display') && 'none' === K.css(t, 'float') && (K.support.inlineBlockNeedsLayout && 'inline' !== _(t.nodeName) ? d.zoom = 1 : d.display = 'inline-block')),
    n.overflow && (d.overflow = 'hidden', K.support.shrinkWrapBlocks || h.done(function () {
      d.overflow = n.overflow[0],
      d.overflowX = n.overflow[1],
      d.overflowY = n.overflow[2]
    }));
    for (r in e) if (o = e[r], Gn.exec(o)) {
      if (delete e[r], s = s || 'toggle' === o, o === (m ? 'hide' : 'show')) continue;
      g.push(r)
    }
    if (a = g.length) {
      u = K._data(t, 'fxshow') || K._data(t, 'fxshow', {
      }),
      'hidden' in u && (m = u.hidden),
      s && (u.hidden = !m),
      m ? K(t).show()  : h.done(function () {
        K(t).hide()
      }),
      h.done(function () {
        var e;
      ...
      for (r = 0; a > r; r++) i = g[r],
      c = h.createTween(i, m ? u[i] : 0),
      p[i] = u[i] || K.style(t, i),
      i in u || (u[i] = c.start, m && (c.end = c.start, c.start = 'width' === i || 'height' === i ? 1 : 0))
    }
  }
  ...
  K.fn = K.prototype = {
    ...
    init: function (t, n, r) {
      ...
      a;
      if (!t) return this;
      if (t.nodeType) return this.context = this[0] = t,
      this.length = 1,
      this;
      if ('string' == typeof t) {
        if (i = '<' === t.charAt(0) && '>' === t.charAt(t.length - 1) && t.length >= 3 ? [
          null,
          t,
          null
        ] : re.exec(t), i && (i[1] || !n)) {
          ...
          t = K.parseHTML(i[1], a, !0),
          ie.test(i[1]) && K.isPlainObject(n) && this.attr.call(t, n, !0),
          K.merge(this, t);
    ...
    pushStack: function (t, e, n) {
      ...
      'find' === e ? r.selector = this.selector + (this.selector ? ' ' : '') + n : e && (r.selector = this.selector + '.' + e + '(' + n + ')'),
      r
    },
    each: function (t, e) {
  ...
  K.extend = K.fn.extend = function () {
    ...
    }, s = 2), 'object' != typeof u && !K.isFunction(u) && (u = {
    }), c === s && (u = this, --s); c > s; s++) if (null != (t = arguments[s])) for (n in t) r = u[n],
    i = t[n],
    u !== i && (l && i && (K.isPlainObject(i) || (o = K.isArray(i))) ? (o ? (o = !1, a = r && K.isArray(r) ? r : [
    ])  : a = r && K.isPlainObject(r) ? r : {
    }, u[n] = K.extend(l, a, i))  : i !== e && (u[n] = i));
    return u
  },
  K.extend({
    noConflict: function (e) {
      return t.$ === K && (t.$ = W),
      e && t.jQuery === K && (t.jQuery = I),
      K
    },
    isReady: !1,
    readyWait: 1,
    ...
    ready: function (t) {
      if (t === !0 ? !--K.readyWait : !K.isReady) {
        ...
        K.isReady = !0,
        t !== !0 && --K.readyWait > 0 || (z.resolveWith(R, [
          K
    ...
    parseHTML: function (t, e, n) {
      var r;
      return t && 'string' == typeof t ? ('boolean' == typeof e && (n = e, e = 0), e = e || R, (r = ie.exec(t)) ? [
        e.createElement(r[1])
      ] : (r = K.buildFragment([t], e, n ? null : [
    ...
    each: function (t, n, r) {
      ...
      } else for (; a > o && n.apply(t[o++], r) !== !1; );
       else if (u) {
        for (i in t) if (n.call(t[i], i, t[i]) === !1) break
      } else for (; a > o && n.call(t[o], o, t[o++]) !== !1; );
      return t
    },
    ...
    makeArray: function (t, e) {
      var n,
      r = e || [];
      return null != t && (n = K.type(t), null == t.length || 'string' === n || 'function' === n || 'regexp' === n || K.isWindow(t) ? U.call(r, t)  : K.merge(r, t)),
      r
    },
    ...
    proxy: function (t, n) {
      ...
      K.isFunction(t) ? (i = X.call(arguments, 2), o = function () {
    ...
    access: function (t, n, r, i, o, a, u) {
      ...
      if (r && 'object' == typeof r) {
        ...
        if (s = u === e && K.isFunction(i), c && (s ? (s = n, n = function (t, e, n) {
          return s.call(K(t), n)
        })  : (n.call(t, i), n = null)), n) for (; f > l; l++) n(t[l], r, s ? i.call(t[l], l, n(t[l], r))  : i, u);
        o = 1
      }
  ...
  K.ready.promise = function (e) {
    if (!z) if (z = K.Deferred(), 'complete' === R.readyState) setTimeout(K.ready, 1);
     else if (R.addEventListener) R.addEventListener('DOMContentLoaded', he, !1),
    t.addEventListener('load', K.ready, !1);
     else {
      R.attachEvent('onreadystatechange', he),
      t.attachEvent('onload', K.ready);
      var n = !1;
      try {
  ...
  K.Callbacks = function (t) {
    t = 'string' == typeof t ? pe[t] || n(t)  : K.extend({
    }, t);
    var r,
    i,
    o,
    ...
    l = !t.once && [],
    f = function (e) {
      for (r = t.memory && e, i = !0, s = a || 0, a = 0, u = c.length, o = !0; c && u > s; s++) if (c[s].apply(e[0], e[1]) === !1 && t.stopOnFalse) {
        r = !1;
        break
      }
      o = !1,
      c && (l ? l.length && f(l.shift())  : r ? c = [
      ] : h.disable())
    },
    h = {
      add: function () {
        if (c) {
          ...
          o ? u = c.length : r && (a = e, f(r))
        }
        return this
      },
      remove: function () {
        return c && K.each(arguments, function (t, e) {
          for (var n; (n = K.inArray(e, c, n)) > - 1; ) c.splice(n, 1),
          o && (u >= n && u--, s >= n && s--)
        }),
        this
      },
  ...
  K.extend({
          ...
          return K.Deferred(function (n) {
            K.each(e, function (e, r) {
              ...
              i[r[1]](K.isFunction(a) ? function () {
                ...
                t && K.isFunction(t.promise) ? t.promise().done(n.resolve).fail(n.reject).progress(n.notify)  : n[o + 'With'](this === i ? n : this, [
                  t
                ])
              }
               : n[o])
    ...
    when: function (t) {
      ...
      c = function (t, n, r) {
        return function (i) {
          n[t] = this,
          r[t] = arguments.length > 1 ? X.call(arguments)  : i,
          r === e ? s.notifyWith(n, r)  : --u || s.resolveWith(n, r)
        }
      };
      if (a > 1) for (e = Array(a), n = Array(a), r = Array(a); a > i; i++) o[i] && K.isFunction(o[i].promise) ? o[i].promise().done(c(i, r, o)).fail(s.reject).progress(c(i, n, e))  : --u;
      return u || s.resolveWith(r, o),
      s.promise()
    }
  }),
  K.support = function () {
    ...
    return K(function () {
      ...
      u && (n = R.createElement('div'), n.style.cssText = 'visibility:hidden;border:0;width:0;height:0;position:static;top:0;margin-top:1px', u.insertBefore(n, u.firstChild), r = R.createElement('div'), n.appendChild(r), r.innerHTML = '<table><tr><td></td><td>t</td></tr></table>', i = r.getElementsByTagName('td'), i[0].style.cssText = 'padding:0;margin:0;border:0;display:none', l = 0 === i[0].offsetHeight, i[0].style.display = '', i[1].style.display = 'none', e.reliableHiddenOffsets = l && 0 === i[0].offsetHeight, r.innerHTML = '', r.style.cssText = 'box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;', e.boxSizing = 4 === r.offsetWidth, e.doesNotIncludeMarginInBodyOffset = 1 !== u.offsetTop, t.getComputedStyle && (e.pixelPosition = '1%' !== (t.getComputedStyle(r, null) || {
      }).top, e.boxSizingReliable = '4px' === (t.getComputedStyle(r, null) || {
        width: '4px'
      }).width, o = R.createElement('div'), o.style.cssText = r.style.cssText = a, o.style.marginRight = o.style.width = '0', r.style.width = '1px', r.appendChild(o), e.reliableMarginRight = !parseFloat((t.getComputedStyle(o, null) || {
      }).marginRight)), r.style.zoom !== void 0 && (r.innerHTML = '', r.style.cssText = a + 'width:1px;padding:1px;display:inline;zoom:1', e.inlineBlockNeedsLayout = 3 === r.offsetWidth, r.style.display = 'block', r.style.overflow = 'visible', r.innerHTML = '<div></div>', r.firstChild.style.width = '5px', e.shrinkWrapBlocks = 3 !== r.offsetWidth, n.style.zoom = 1), u.removeChild(n), n = r = i = o = null)
    }),
    u.removeChild(h),
    n = r = i = o = a = u = h = null,
    e
  ...
  K.extend({
    ...
    hasData: function (t) {
      return t = t.nodeType ? K.cache[t[K.expando]] : t[K.expando],
      !!t && !i(t)
    },
    data: function (t, n, r, i) {
      if (K.acceptData(t)) {
        ...
        l = c ? K.cache : t,
        f = c ? t[u] : t[u] && u;
        if (f && l[f] && (i || l[f].data) || !s || r !== e) return f || (c ? t[u] = f = K.deletedIds.pop() || K.guid++ : f = u),
        l[f] || (l[f] = {
        }, c || (l[f].toJSON = K.noop)),
        ('object' == typeof n || 'function' == typeof n) && (i ? l[f] = K.extend(l[f], n)  : l[f].data = K.extend(l[f].data, n)),
        o = l[f],
        i || (o.data || (o.data = {
        }), o = o.data),
        r !== e && (o[K.camelCase(n)] = r),
        s ? (a = o[n], null == a && (a = o[K.camelCase(n)]))  : a = o,
        a
      }
    },
      ...
      if (K.acceptData(t)) {
        ...
        if (s[c]) {
          if (e && (r = n ? s[c] : s[c].data)) {
            K.isArray(e) || (e in r ? e = [
              e
            ] : (e = K.camelCase(e), e = e in r ? [
              e
            ] : e.split(' ')));
    ...
    data: function (t, n) {
      ...
      if (t === e) {
        if (this.length && (f = K.data(c), 1 === c.nodeType && !K._data(c, 'parsedAttrs'))) {
          for (a = c.attributes, s = a.length; s > l; l++) u = a[l].name,
          u.indexOf('data-') || (u = K.camelCase(u.substring(5)), r(c, u, f[u]));
      ...
      return 'object' == typeof t ? this.each(function () {
        ...
        return n === e ? (f = this.triggerHandler('getData' + o, [
          i[0]
        ]), f === e && c && (f = K.data(c, t), f = r(c, t, f)), f === e && i[1] ? this.data(i[0])  : f)  : (i[1] = n, this.each(function () {
          var e = K(this);
  ...
  K.fn.extend({
    queue: function (t, n) {
      var r = 2;
      return 'string' != typeof t && (n = t, t = 'fx', r--),
      r > arguments.length ? K.queue(this[0], t)  : n === e ? this : this.each(function () {
    ...
    promise: function (t, n) {
      ...
      for ('string' != typeof t && (n = t, t = e), t = t || 'fx'; u--; ) r = K._data(a[u], t + 'queueHooks'),
      r && r.empty && (i++, r.empty.add(s));
      return s(),
      o.promise(n)
    }
  });
  ...
  K.fn.extend({
    ...
    addClass: function (t) {
      ...
      if (t && 'string' == typeof t) for (e = t.split(ee), n = 0, r = this.length; r > n; n++) if (i = this[n], 1 === i.nodeType) if (i.className || 1 !== e.length) {
    ...
    removeClass: function (t) {
      ...
      if (t && 'string' == typeof t || t === e) for (n = (t || '').split(ee), u = 0, s = this.length; s > u; u++) if (i = this[u], 1 === i.nodeType && i.className) {
        for (r = (' ' + i.className + ' ').replace(be, ' '), o = 0, a = n.length; a > o; o++) for (; r.indexOf(' ' + n[o] + ' ') >= 0; ) r = r.replace(' ' + n[o] + ' ', ' ');
    ...
    toggleClass: function (t, e) {
      ...
      return K.isFunction(t) ? this.each(function (n) {
        ...
        if ('string' === n) for (var i, o = 0, a = K(this), u = e, s = t.split(ee); i = s[o++]; ) u = r ? u : !a.hasClass(i),
    ...
    val: function (t) {
      ...
      o = this[0];
      {
        if (arguments.length) return i = K.isFunction(t),
        ...
        n && 'get' in n && (r = n.get(o, 'value')) !== e ? r : (r = o.value, 'string' == typeof r ? r.replace(Me, '')  : null == r ? '' : r)
      }
    }
  }),
  K.extend({
    valHooks: {
      ...
      select: {
        get: function (t) {
          for (var e, n, r = t.options, i = t.selectedIndex, o = 'select-one' === t.type || 0 > i, a = o ? null : [
          ], u = o ? i + 1 : r.length, s = 0 > i ? u : o ? i : 0; u > s; s++) if (n = r[s], !(!n.selected && s !== i || (K.support.optDisabled ? n.disabled : null !== n.getAttribute('disabled')) || n.parentNode.disabled && K.nodeName(n.parentNode, 'optgroup'))) {
    ...
    removeAttr: function (t, e) {
      ...
      o,
      a = 0;
      if (e && 1 === t.nodeType) for (r = e.split(ee); r.length > a; a++) i = r[a],
      i && (n = K.propFix[i] || i, o = Te.test(i), o || K.attr(t, i, ''), t.removeAttribute(Se ? i : n), o && n in t && (t[n] = !1))
    },
    attrHooks: {
      type: {
        set: function (t, e) {
    ...
    prop: function (t, n, r) {
      ...
      a,
      u = t.nodeType;
      if (t && 3 !== u && 8 !== u && 2 !== u) return a = 1 !== u || !K.isXMLDoc(t),
      a && (n = K.propFix[n] || n, o = K.propHooks[n]),
      r !== e ? o && 'set' in o && (i = o.set(t, r, n)) !== e ? i : t[n] = r : o && 'get' in o && null !== (i = o.get(t, n)) ? i : t[n]
    },
    propHooks: {
      tabIndex: {
        get: function (t) {
  ...
  ye = {
    ...
    set: function (t, e, n) {
      var r;
      return e === !1 ? K.removeAttr(t, n)  : (r = K.propFix[n] || n, r in t && (t[r] = !0), t.setAttribute(n, n.toLowerCase())),
      n
    }
  },
  Se || (xe = {
    ...
    get: function (t, n) {
      ...
      r && (xe[n] ? '' !== r.value : r.specified) ? r.value : e
    },
    set: function (t, e, n) {
      var r = t.getAttributeNode(n);
      return r || (r = R.createAttribute(n), t.setAttributeNode(r)),
      r.value = e + ''
    }
  }, K.each(['width',
  'height'], function (t, e) {
  ...
  K.support.hrefNormalized || K.each(['href',
  'src',
  'width',
  'height'], function (t, n) {
  ...
  K.support.checkOn || K.each(['radio',
  'checkbox'], function () {
    K.valHooks[this] = {
      get: function (t) {
  ...
  K.event = {
    add: function (t, n, r, i, o) {
      ...
      if (3 !== t.nodeType && 8 !== t.nodeType && n && r && (a = K._data(t))) {
        for (r.handler && (p = r, r = p.handler, o = p.selector), r.guid || (r.guid = K.guid++), s = a.events, s || (a.events = s = {
        }), u = a.handle, u || (a.handle = u = function (t) {
          return K === void 0 || t && K.event.triggered === t.type ? e : K.event.dispatch.apply(u.elem, arguments)
        }, u.elem = t), n = K.trim(He(n)).split(' '), c = 0; n.length > c; c++) l = Ne.exec(n[c]) || [],
        f = l[1],
        h = (l[2] || '').split('.').sort(),
        m = K.event.special[f] || {
        },
        ...
        g = s[f],
        g || (g = s[f] = [
        ], g.delegateCount = 0, m.setup && m.setup.call(t, i, h, u) !== !1 || (t.addEventListener ? t.addEventListener(f, u, !1)  : t.attachEvent && t.attachEvent('on' + f, u))),
        m.add && (m.add.call(t, d), d.handler.guid || (d.handler.guid = r.guid)),
    ...
    remove: function (t, e, n, r, i) {
      ...
      p,
      g,
      m = K.hasData(t) && K._data(t);
      if (m && (h = m.events)) {
        for (e = K.trim(He(e || '')).split(' '), o = 0; e.length > o; o++) if (a = Ne.exec(e[o]) || [], u = s = a[1], c = a[2], u) {
          for (d = K.event.special[u] || {
          }, u = (r ? d.delegateType : d.bindType) || u, p = h[u] || [], l = p.length, c = c ? RegExp('(^|\\.)' + c.split('.').sort().join('\\.(?:.*\\.|)') + '(\\.|$)')  : null, f = 0; p.length > f; f++) g = p[f],
          !(!i && s !== g.origType || n && n.guid !== g.guid || c && !c.test(g.namespace) || r && r !== g.selector && ('**' !== r || !g.selector) || (p.splice(f--, 1), g.selector && p.delegateCount--, !d.remove || !d.remove.call(t, g)));
          0 === p.length && l !== p.length && ((!d.teardown || d.teardown.call(t, c, m.handle) === !1) && K.removeEvent(t, u, m.handle), delete h[u])
        } else for (u in h) K.event.remove(t, u + e[o], n, r, !0);
    ...
    trigger: function (n, r, i, o) {
      if (!i || 3 !== i.nodeType && 8 !== i.nodeType) {
        ...
        if (n.result = e, n.target || (n.target = i), r = null != r ? K.makeArray(r)  : [
        ], r.unshift(n), h = K.event.special[m] || {
        }, h.trigger && h.trigger.apply(i, r) === !1) return;
        if (p = [
          [i,
          h.bindType || m]
        ], !o && !h.noBubble && !K.isWindow(i)) {
          for (g = h.delegateType || m, c = Le.test(g + m) ? i : i.parentNode, l = i; c; c = c.parentNode) p.push([c,
          g]),
          l = c;
          l === (i.ownerDocument || R) && p.push([l.defaultView || l.parentWindow || t,
          g])
        }
        for (s = 0; p.length > s && !n.isPropagationStopped(); s++) c = p[s][0],
        n.type = p[s][1],
        d = (K._data(c, 'events') || {
        }) [n.type] && K._data(c, 'handle'),
        d && d.apply(c, r),
        d = f && c[f],
        d && K.acceptData(c) && d.apply && d.apply(c, r) === !1 && n.preventDefault();
        return n.type = m,
        !(o || n.isDefaultPrevented() || h._default && h._default.apply(i.ownerDocument, r) !== !1 || 'click' === m && K.nodeName(i, 'a') || !K.acceptData(i) || !f || !i[m] || ('focus' === m || 'blur' === m) && 0 === n.target.offsetWidth || K.isWindow(i) || (l = i[f], l && (i[f] = null), K.event.triggered = m, i[m](), K.event.triggered = e, !l || !(i[f] = l))),
        n.result
      }
    },
    dispatch: function (n) {
      ...
      if (p[0] = n, n.delegateTarget = this, !m.preDispatch || m.preDispatch.call(this, n) !== !1) {
        if (d && (!n.button || 'click' !== n.type)) for (o = n.target; o != this; o = o.parentNode || this) if (o.disabled !== !0 || 'click' !== n.type) {
          ...
          f = l.selector,
          u[f] === e && (u[f] = l.needsContext ? K(f, this).index(o) >= 0 : K.find(f, this, null, [
            o
          ]).length),
          u[f] && c.push(l);
          c.length && v.push({
        ...
        for (h.length > d && v.push({
          elem: this,
          matches: h.slice(d)
        }), r = 0; v.length > r && !n.isPropagationStopped(); r++) for (s = v[r], n.currentTarget = s.elem, i = 0; s.matches.length > i && !n.isImmediatePropagationStopped(); i++) l = s.matches[i],
        (g || !n.namespace && !l.namespace || n.namespace_re && n.namespace_re.test(l.namespace)) && (n.data = l.data, n.handleObj = l, a = ((K.event.special[l.origType] || {
        }).handle || l.handler).apply(s.elem, p), a !== e && (n.result = a, a === !1 && (n.preventDefault(), n.stopPropagation())));
    ...
    mouseHooks: {
      ...
      filter: function (t, n) {
        ...
        a = n.button,
        u = n.fromElement;
        return null == t.pageX && null != n.clientX && (r = t.target.ownerDocument || R, i = r.documentElement, o = r.body, t.pageX = n.clientX + (i && i.scrollLeft || o && o.scrollLeft || 0) - (i && i.clientLeft || o && o.clientLeft || 0), t.pageY = n.clientY + (i && i.scrollTop || o && o.scrollTop || 0) - (i && i.clientTop || o && o.clientTop || 0)),
        !t.relatedTarget && u && (t.relatedTarget = u === t.target ? n.toElement : u),
    ...
    fix: function (t) {
      ...
      for (t = K.Event(r), e = o.length; e; ) n = o[--e],
      t[n] = r[n];
      return t.target || (t.target = r.srcElement || R),
      3 === t.target.nodeType && (t.target = t.target.parentNode),
      t.metaKey = !!t.metaKey,
      i.filter ? i.filter(t, r)  : t
    },
    special: {
      load: {
        noBubble: !0
  ...
  K.removeEvent = R.removeEventListener ? function (t, e, n) {
  ...
  K.each({
    ...
    K.event.special[t] = {
      ...
      handle: function (t) {
        ...
        o = t.handleObj;
        return o.selector,
        (!i || i !== r && !K.contains(r, i)) && (t.type = o.origType, n = o.handler.apply(this, arguments), t.type = e),
        n
      }
    }
  }),
  ...
  K.support.changeBubbles || (K.event.special.change = {
    setup: function () {
      return Ee.test(this.nodeName) ? (('checkbox' === this.type || 'radio' === this.type) && (K.event.add(this, 'propertychange._change', function (t) {
        ...
        K.event.simulate('change', this, t, !0)
  ...
  K.fn.extend({
    ...
    off: function (t, n, r) {
      ...
      return (n === !1 || 'function' == typeof n) && (r = n, n = e),
      r === !1 && (r = o),
      this.each(function () {
    ...
    live: function (t, e, n) {
      return K(this.context).on(t, this.selector, e, n),
      this
    },
    die: function (t, e) {
      return K(this.context).off(t, this.selector || '**', e),
      this
    },
    ...
    toggle: function (t) {
      ...
      i = function (n) {
        ...
        return K._data(this, 'lastToggle' + t.guid, i + 1),
        n.preventDefault(),
        e[i].apply(this, arguments) || !1
      };
  ...
  K.each('blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu'.split(' '), function (t, e) {
    K.fn[e] = function (t, n) {
      return null == n && (n = t, t = null),
      arguments.length > 0 ? this.on(e, null, t, n)  : this.trigger(e)
    },
    Ae.test(e) && (K.event.fixHooks[e] = K.event.keyHooks),
    De.test(e) && (K.event.fixHooks[e] = K.event.mouseHooks)
  }),
  function (t, e) {
    function n(t, e, n, r) {
      n = n || [],
      ...
      if (1 !== s && 9 !== s) return [];
      if (a = M(e), !a && !r && (i = ne.exec(t))) if (u = i[1]) {
        if (9 === s) {
          if (o = e.getElementById(u), !o || !o.parentNode) return n;
          if (o.id === u) return n.push(o),
          n
        } else if (e.ownerDocument && (o = e.ownerDocument.getElementById(u)) && _(e, o) && o.id === u) return n.push(o),
        n
      } else {
        if (i[2]) return q.apply(n, O.call(e.getElementsByTagName(t), 0)),
        n;
        if ((u = i[3]) && he && e.getElementsByClassName) return q.apply(n, O.call(e.getElementsByClassName(u), 0)),
        n
      }
    ...
    function u(t, e) {
      ...
      for (u = t, s = [
        ...
        (!r || (i = Q.exec(u))) && (i && (u = u.slice(i[0].length) || u), s.push(o = [
        ])),
        r = !1,
        (i = te.exec(u)) && (o.push(r = new A(i.shift())), u = u.slice(r.length), r.type = i[0].replace(J, ' '));
    ...
    function s(t, e, n) {
      ...
      return e.first ? function (e, n, o) {
       ...
       : function (e, n, a) {
        ...
        } else for (var u, s = H + ' ' + o + ' ', c = s + v; e = e[r]; ) if (i || 1 === e.nodeType) {
          if ((u = e[C]) === c) return e.sizset;
          if ('string' == typeof u && 0 === u.indexOf(s)) {
            if (e.sizset) return e
          } else {
            if (e[C] = c, t(e, n, a)) return e.sizset = !0,
            e;
            e.sizset = !1
          }
        }
    ...
    function l(t, e, n, r, i) {
      for (var o, a = [
      ], u = 0, s = t.length, c = null != e; s > u; u++) (o = t[u]) && (!n || n(o, r, i)) && (a.push(o), c && e.push(u));
      return a
    }
    function f(t, e, n, r, i, o) {
      ...
      Y(function (o, a, u, s) {
        ...
        if (n && n(y, x, u, s), r) for (c = l(x, g), r(c, [
        ], u, s), f = c.length; f--; ) (h = c[f]) && (x[g[f]] = !(y[g[f]] = h));
        if (o) {
          if (i || t) {
            if (i) {
              for (c = [
              ], f = x.length; f--; ) (h = x[f]) && c.push(y[f] = h);
              i(null, x = [
              ], c, s)
            }
            for (f = x.length; f--; ) (h = x[f]) && (c = i ? P.call(o, h)  : d[f]) > - 1 && (o[c] = !(a[c] = h))
          }
        } else x = l(x === a ? x.splice(m, x.length)  : x),
        i ? i(null, a, x, s)  : q.apply(a, x)
      })
    }
    function h(t) {
      ...
      ]; i > u; u++) if (n = x.relative[t[u].type]) p = [
        s(c(p), n)
      ];
       else {
    ...
    function d(t, e) {
      ...
      o = function (a, u, s, c, f) {
        ...
        if (m += y, r && y !== m) {
          ...
          if (a) {
            if (m > 0) for (; y--; ) !b[y] && !g[y] && (g[y] = F.call(c));
            g = l(g)
          }
          q.apply(c, g),
          M && !a && g.length > 0 && m + e.length > 1 && n.uniqueSort(c)
        }
        return M && (H = k, S = _),
        b
      };
    ...
    function g(t, e, n, r, i) {
      ...
      if (f.length, !r && 1 === f.length) {
        ...
        for (o = ue.POS.test(t) ? - 1 : a.length - 1; o >= 0 && (s = a[o], !x.relative[c = s.type]); o--) if ((l = x.find[c]) && (r = l(s.matches[0].replace(ae, ''), re.test(a[0].type) && e.parentNode || e, i))) {
          if (a.splice(o, 1), t = r.length && a.join(''), !t) return q.apply(n, O.call(r, 0)),
          n;
          break
        }
      }
      return w(t, f) (r, e, i, n, re.test(t)),
      n
    }
    function m() {
    }
    ...
    le = se(function (t) {
      ...
      t.firstChild && typeof t.firstChild.getAttribute !== N && '#' === t.firstChild.getAttribute('href')
    }),
    fe = se(function (t) {
    ...
    n.attr = function (t, e) {
      ...
      (n = x.attrHandle[e]) ? n(t)  : r || fe ? t.getAttribute(e)  : (n = t.getAttributeNode(e), n ? 'boolean' == typeof t[e] ? t[e] ? e : null : n.specified ? n.value : null : null)
    },
    x = n.selectors = {
      cacheLength: 50,
      createPseudo: Y,
      ...
      find: {
        ID: y ? function (t, e, n) {
         ...
         : function (t, n, r) {
          if (typeof n.getElementById !== N && !r) {
            ...
            return i ? i.id === t || typeof i.getAttributeNode !== N && i.getAttributeNode('id').value === t ? [
              i
            ] : e : [
            ]
          }
        ...
        TAG: ce ? function (t, e) {
         ...
         : function (t, e) {
          ...
          if ('*' === t) {
            for (var r, i = [
            ], o = 0; r = n[o]; o++) 1 === r.nodeType && i.push(r);
            return i
          }
          return n
        },
      ...
      preFilter: {
        ATTR: function (t) {
          return t[1] = t[1].replace(ae, ''),
          t[3] = (t[4] || t[5] || '').replace(ae, ''),
          '~=' === t[2] && (t[3] = ' ' + t[3] + ' '),
          t.slice(0, 4)
        },
        CHILD: function (t) {
          return t[1] = t[1].toLowerCase(),
          'nth' === t[1] ? (t[2] || n.error(t[0]), t[3] = + (t[3] ? t[4] + (t[5] || 1)  : 2 * ('even' === t[2] || 'odd' === t[2])), t[4] = + (t[6] + t[7] || 'odd' === t[2]))  : t[2] && n.error(t[0]),
          t
        },
        PSEUDO: function (t) {
          var e,
      ...
      filter: {
        ...
        PSEUDO: function (t, e) {
          var r,
          i = x.pseudos[t] || x.setFilters[t.toLowerCase()] || n.error('unsupported pseudo: ' + t);
          return i[C] ? i(e)  : i.length > 1 ? (r = [
            t,
            t,
            '',
            e
          ], x.setFilters.hasOwnProperty(t.toLowerCase()) ? Y(function (t, n) {
            for (var r, o = i(t, e), a = o.length; a--; ) r = P.call(t, o[a]),
            t[r] = !(n[r] = o[a])
          })  : function (t) {
            return i(t, 0, r)
          })  : i
      ...
      pseudos: {
        not: Y(function (t) {
          ...
          return r[C] ? Y(function (t, e, n, i) {
            for (var o, a = r(t, null, i, [
            ]), u = t.length; u--; ) (o = a[u]) && (t[u] = !(e[u] = o))
          })  : function (t, i, o) {
            return e[0] = t,
            r(e, null, o, n),
            !n.pop()
    ...
    w = n.compile = function (t, e) {
      ...
      o = B[C][t + ' '];
      if (!o) {
        for (e || (e = u(t)), n = e.length; n--; ) o = h(e[n]),
        o[C] ? r.push(o)  : i.push(o);
        o = B(t, d(i, r))
      }
      return o
    },
    D.querySelectorAll && function () {
      ...
      se(function (t) {
        ...
        t.querySelectorAll('[selected]').length || o.push('\\[' + I + '*(?:checked|disabled|ismap|multiple|readonly|selected|value)'),
        t.querySelectorAll(':checked').length || o.push(':checked')
      }),
      se(function (t) {
        t.innerHTML = '<p test=\'\'></p>',
        t.querySelectorAll('[test^=\'\']').length && o.push('[*^$]=' + I + '*(?:""|\'\')'),
        t.innerHTML = '<input type=\'hidden\'/>',
        t.querySelectorAll(':enabled').length || o.push(':enabled', ':disabled')
      }),
      o = RegExp(o.join('|')),
      g = function (t, n, i, a, s) {
        if (!a && !s && !o.test(t)) {
          var c,
          l,
          f = !0,
          ...
          if (1 === n.nodeType && 'object' !== n.nodeName.toLowerCase()) {
            ...
            d = re.test(t) && n.parentNode || n,
            p = c.join(',')
          }
          if (p) try {
            return q.apply(i, O.call(d.querySelectorAll(p), 0)),
            i
          } catch (g) {
          } finally {
  ...
  K.fn.extend({
    find: function (t) {
      ...
      if ('string' != typeof t) return K(t).filter(function () {
        for (e = 0, n = u.length; n > e; e++) if (K.contains(u[e], this)) return !0
      });
      for (a = this.pushStack('', 'find', t), e = 0, n = this.length; n > e; e++) if (r = a.length, K.find(t, this[e], a), e > 0) for (i = r; a.length > i; i++) for (o = 0; r > o; o++) if (a[o] === a[i]) {
        a.splice(i--, 1);
        break
      }
      return a
    ...
    has: function (t) {
      ...
      return this.filter(function () {
        for (e = 0; r > e; e++) if (K.contains(this, n[e])) return !0
      })
    },
    not: function (t) {
    ...
    closest: function (t, e) {
      ...
      ], a = Oe.test(t) || 'string' != typeof t ? K(t, e || this.context)  : 0; i > r; r++) for (n = this[r]; n && n.ownerDocument && n !== e && 11 !== n.nodeType; ) {
    ...
    add: function (t, e) {
      var n = 'string' == typeof t ? K(t, e)  : K.makeArray(t && t.nodeType ? [
        t
      ] : t),
  ...
  K.each({
    ...
    K.fn[t] = function (n, r) {
      ...
      return je.test(t) || (r = n),
      r && 'string' == typeof r && (i = K.filter(r, i)),
      i = this.length > 1 && !Pe[t] ? K.unique(i)  : i,
      this.length > 1 && Fe.test(t) && (i = i.reverse()),
      this.pushStack(i, t, X.call(arguments).join(','))
    }
  }),
  K.extend({
    filter: function (t, e, n) {
      return n && (t = ':not(' + t + ')'),
      1 === e.length ? K.find.matchesSelector(e[0], t) ? [
        e[0]
      ] : [
      ] : K.find.matches(t, e)
    },
    dir: function (t, n, r) {
      for (var i = [
      ], o = t[n]; o && 9 !== o.nodeType && (r === e || 1 !== o.nodeType || !K(o).is(r)); ) 1 === o.nodeType && i.push(o),
      o = o[n];
      return i
    },
  ...
  Qe.th = Qe.td,
  K.support.htmlSerialize || (Qe._default = [
    1,
    'X<div>',
    '</div>'
  ]),
  K.fn.extend({
    ...
    remove: function (t, e) {
      for (var n, r = 0; null != (n = this[r]); r++) (!t || K.filter(t, [
        n
      ]).length) && (!e && 1 === n.nodeType && (K.cleanData(n.getElementsByTagName('*')), K.cleanData([n])), n.parentNode && n.parentNode.removeChild(n));
      return this
    },
    empty: function () {
      for (var t, e = 0; null != (t = this[e]); e++) for (1 === t.nodeType && K.cleanData(t.getElementsByTagName('*')); t.firstChild; ) t.removeChild(t.firstChild);
      return this
    },
    clone: function (t, e) {
      return t = null == t ? !1 : t,
    ...
    html: function (t) {
      return K.access(this, function (t) {
        ...
        if (!('string' != typeof t || Ue.test(t) || !K.support.htmlSerialize && Ve.test(t) || !K.support.leadingWhitespace && Re.test(t) || Qe[(Be.exec(t) || ['',
        '']) [1].toLowerCase()])) {
          t = t.replace($e, '<$1></$2>');
          try {
            for (; i > r; r++) n = this[r] || {
            },
            1 === n.nodeType && (K.cleanData(n.getElementsByTagName('*')), n.innerHTML = t);
            n = 0
          } catch (o) {
          }
        }
    ...
    domManip: function (t, n, r) {
      ...
      if (K.isFunction(c)) return this.each(function (i) {
        var o = K(this);
        t[0] = c.call(this, i, n ? o.html()  : e),
        o.domManip(t, n, r)
      });
      if (this[0]) {
        if (i = K.buildFragment(t, this, l), a = i.fragment, o = a.firstChild, 1 === a.childNodes.length && (a = o), o) for (n = n && K.nodeName(o, 'tr'), u = i.cacheable || h - 1; h > s; s++) r.call(n && K.nodeName(this[s], 'table') ? f(this[s], 'tbody')  : this[s], s === u ? a : K.clone(a, !0, !0));
        a = o = null,
        l.length && K.each(l, function (t, e) {
          e.src ? K.ajax ? K.ajax({
            ...
            global: !1,
            'throws': !0
          })  : K.error('no ajax')  : K.globalEval((e.text || e.textContent || e.innerHTML || '').replace(Ke, '')),
  ...
  K.buildFragment = function (t, n, r) {
    ...
    n = !n.nodeType && n[0] || n,
    n = n.ownerDocument || n,
    1 === t.length && 'string' == typeof u && 512 > u.length && n === R && '<' === u.charAt(0) && !Xe.test(u) && (K.support.checkClone || !Ge.test(u)) && (K.support.html5Clone || !Ve.test(u)) && (o = !0, i = K.fragments[u], a = i !== e),
    i || (i = n.createDocumentFragment(), K.clean(t, n, i, r), o && (K.fragments[u] = a && i)),
    {
      fragment: i,
      cacheable: o
    }
  ...
  K.each({
    ...
    K.fn[t] = function (n) {
      ...
      if ((null == s || s && 11 === s.nodeType && 1 === s.childNodes.length) && 1 === u) return a[e](this[0]),
      this;
      for (; u > i; i++) r = (i > 0 ? this.clone(!0)  : this).get(),
      K(a[i]) [e](r),
      o = o.concat(r);
  ...
  K.extend({
    clone: function (t, e, n) {
      ...
      o,
      a;
      if (K.support.html5Clone || K.isXMLDoc(t) || !Ve.test('<' + t.nodeName + '>') ? a = t.cloneNode(!0)  : (en.innerHTML = t.outerHTML, en.removeChild(a = en.firstChild)), !(K.support.noCloneEvent && K.support.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || K.isXMLDoc(t))) for (d(t, a), r = p(t), i = p(a), o = 0; r[o]; ++o) i[o] && d(r[o], i[o]);
      if (e && (h(t, a), n)) for (r = p(t), i = p(a), o = 0; r[o]; ++o) h(r[o], i[o]);
      return r = i = null,
      a
    },
    clean: function (t, e, n, r) {
      ...
      for (e && void 0 !== e.createDocumentFragment || (e = R), i = 0; null != (a = t[i]); i++) if ('number' == typeof a && (a += ''), a) {
        if ('string' == typeof a) if (We.test(a)) {
          for (v = v || l(e), f = e.createElement('div'), v.appendChild(f), a = a.replace($e, '<$1></$2>'), u = (Be.exec(a) || ['',
          '']) [1].toLowerCase(), s = Qe[u] || Qe._default, c = s[0], f.innerHTML = s[1] + a + s[2]; c--; ) f = f.lastChild;
          if (!K.support.tbody) for (h = Ie.test(a), d = 'table' !== u || h ? '<table>' !== s[1] || h ? [
          ] : f.childNodes : f.firstChild && f.firstChild.childNodes, o = d.length - 1; o >= 0; --o) K.nodeName(d[o], 'tbody') && !d[o].childNodes.length && d[o].parentNode.removeChild(d[o]);
          !K.support.leadingWhitespace && Re.test(a) && f.insertBefore(e.createTextNode(Re.exec(a) [0]), f.firstChild),
          a = f.childNodes,
          f.parentNode.removeChild(f)
        } else a = e.createTextNode(a);
        a.nodeType ? y.push(a)  : K.merge(y, a)
      }
      if (f && (a = f = v = null), !K.support.appendChecked) for (i = 0; null != (a = y[i]); i++) K.nodeName(a, 'input') ? g(a)  : a.getElementsByTagName !== void 0 && K.grep(a.getElementsByTagName('input'), g);
      if (n) for (p = function (t) {
        return !t.type || Je.test(t.type) ? r ? r.push(t.parentNode ? t.parentNode.removeChild(t)  : t)  : n.appendChild(t)  : void 0
      }, i = 0; null != (a = y[i]); i++) K.nodeName(a, 'script') && p(a) || (n.appendChild(a), a.getElementsByTagName !== void 0 && (m = K.grep(K.merge([], a.getElementsByTagName('script')), p), y.splice.apply(y, [
        i + 1,
        0
      ].concat(m)), i += m.length));
      return y
    ...
    cleanData: function (t, e) {
      for (var n, r, i, o, a = 0, u = K.expando, s = K.cache, c = K.support.deleteExpando, l = K.event.special; null != (i = t[a]); a++) if ((e || K.acceptData(i)) && (r = i[u], n = r && s[r])) {
        if (n.events) for (o in n.events) l[o] ? K.event.remove(i, o)  : K.removeEvent(i, o, n.handle);
  ...
  function () {
    ...
    K.sub = function () {
      ...
      t.fn.init = function (n, r) {
        return r && r instanceof K && !(r instanceof t) && (r = t(r)),
        K.fn.init.call(this, n, r, e)
      },
  ...
  K.extend({
    ...
    css: function (t, n, r, i) {
      ...
      u,
      s = K.camelCase(n);
      return n = K.cssProps[s] || (K.cssProps[s] = m(t.style, s)),
      u = K.cssHooks[n] || K.cssHooks[s],
      u && 'get' in u && (o = u.get(t, !0, i)),
      o === e && (o = nn(t, n)),
      'normal' === o && n in mn && (o = mn[n]),
      r || i !== e ? (a = parseFloat(o), r || K.isNumeric(a) ? a || 0 : o)  : o
    },
    swap: function (t, e, n) {
      var r,
      i,
  ...
  t.getComputedStyle ? nn = function (e, n) {
    ...
    o,
    a,
    u = t.getComputedStyle(e, null),
    s = e.style;
    return u && (r = u.getPropertyValue(n) || u[n], '' === r && !K.contains(e.ownerDocument, e) && (r = K.style(e, n)), hn.test(r) && ln.test(n) && (i = s.width, o = s.minWidth, a = s.maxWidth, s.minWidth = s.maxWidth = s.width = r, r = u.width, s.width = i, s.minWidth = o, s.maxWidth = a)),
    r
  }
   : R.documentElement.currentStyle && (nn = function (t, e) {
    var n,
    r,
    i = t.currentStyle && t.currentStyle[e],
    o = t.style;
    return null == i && o && o[e] && (i = o[e]),
    hn.test(i) && !sn.test(e) && (n = o.left, r = t.runtimeStyle && t.runtimeStyle.left, r && (t.runtimeStyle.left = t.currentStyle.left), o.left = 'fontSize' === e ? '1em' : i, i = o.pixelLeft + 'px', o.left = n, r && (t.runtimeStyle.left = r)),
    '' === i ? 'auto' : i
  }),
  K.each(['height',
  'width'], function (t, e) {
  ...
  K.support.opacity || (K.cssHooks.opacity = {
    get: function (t, e) {
      return un.test((e && t.currentStyle ? t.currentStyle.filter : t.style.filter) || '') ? 0.01 * parseFloat(RegExp.$1) + '' : e ? '1' : ''
    },
    set: function (t, e) {
      var n = t.style,
      r = t.currentStyle,
      ...
      n.zoom = 1,
      e >= 1 && '' === K.trim(o.replace(an, '')) && n.removeAttribute && (n.removeAttribute('filter'), r && !r.filter) || (n.filter = an.test(o) ? o.replace(an, i)  : o + ' ' + i)
    }
  }),
  K(function () {
    ...
    !K.support.pixelPosition && K.fn.position && K.each(['top',
    'left'], function (t, e) {
      K.cssHooks[e] = {
        get: function (t, n) {
          if (n) {
  ...
  try {
    ...
    Sn = R.createElement('a'),
    Sn.href = '',
    Sn = Sn.href
  }
  Tn = Fn.exec(Sn.toLowerCase()) || [],
  K.fn.load = function (t, n, r) {
    ...
    u = this,
    s = t.indexOf(' ');
    return s >= 0 && (i = t.slice(s, t.length), t = t.slice(0, s)),
    K.isFunction(n) ? (r = n, n = e)  : n && 'object' == typeof n && (o = 'POST'),
    K.ajax({
      url: t,
      type: o,
      dataType: 'html',
      ...
      complete: function (t, e) {
        r && u.each(r, a || [t.responseText,
        e,
        t])
      }
    }).done(function (t) {
      a = arguments,
      u.html(i ? K('<div>').append(t.replace(Hn, '')).find(i)  : t)
    }),
    this
  },
  ...
  'post'], function (t, n) {
    K[n] = function (t, r, i, o) {
      return K.isFunction(r) && (o = o || i, i = r, r = e),
      K.ajax({
        type: n,
        url: t,
        data: r,
  ...
  K.extend({
    ...
    ajaxSetup: function (t, e) {
      return e ? S(t, K.ajaxSettings)  : (e = t, t = K.ajaxSettings),
      S(t, e),
      t
    },
    ajaxSettings: {
    ...
    ajax: function (t, n) {
      function r(t, n, r, a) {
        ...
        2 !== b && (b = 2, s && clearTimeout(s), u = e, o = a || '', _.readyState = t > 0 ? 4 : 0, r && (x = E(h, _, r)), t >= 200 && 300 > t || 304 === t ? (h.ifModified && (M = _.getResponseHeader('Last-Modified'), M && (K.lastModified[i] = M), M = _.getResponseHeader('Etag'), M && (K.etag[i] = M)), 304 === t ? (w = 'notmodified', c = !0)  : (c = N(h, x), w = c.state, f = c.data, y = c.error, c = !y))  : (y = w, (!w || t) && (w = 'error', 0 > t && (t = 0))), _.status = t, _.statusText = (n || w) + '', c ? g.resolveWith(d, [
          ...
          w,
          y
        ]), _.statusCode(v), v = e, l && p.trigger('ajax' + (c ? 'Success' : 'Error'), [
          _,
          h,
          c ? f : y
        ]), m.fireWith(d, [
      ...
      _ = {
        ...
        getResponseHeader: function (t) {
          ...
          if (2 === b) {
            if (!a) for (a = {
            }; n = Nn.exec(o); ) a[n[1].toLowerCase()] = n[2];
            n = a[t.toLowerCase()]
          }
          return n === e ? null : n
        },
      ...
      h.ifModified && (i = i || h.url, K.lastModified[i] && _.setRequestHeader('If-Modified-Since', K.lastModified[i]), K.etag[i] && _.setRequestHeader('If-None-Match', K.etag[i])),
      _.setRequestHeader('Accept', h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ('*' !== h.dataTypes[0] ? ', ' + Yn + '; q=0.01' : '')  : h.accepts['*']);
  ...
  K.ajaxPrefilter('json jsonp', function (n, r, i) {
    ...
    return 'jsonp' === n.dataTypes[0] || f || h ? (o = n.jsonpCallback = K.isFunction(n.jsonpCallback) ? n.jsonpCallback()  : n.jsonpCallback, a = t[o], f ? n.url = c.replace(Bn, '$1' + o)  : h ? n.data = s.replace(Bn, '$1' + o)  : l && (n.url += ($n.test(c) ? '&' : '?') + n.jsonp + '=' + o), n.converters['script json'] = function () {
      return u || K.error(o + ' was not called'),
      u[0]
    ...
    if (t.crossDomain) {
      ...
      return {
        send: function (i, o) {
          ...
          n.src = t.url,
          n.onload = n.onreadystatechange = function (t, i) {
    ...
    if (!n.crossDomain || K.support.cors) {
      ...
      return {
        send: function (i, o) {
          ...
          u,
          s = n.xhr();
          if (n.username ? s.open(n.type, n.url, n.async, n.username, n.password)  : s.open(n.type, n.url, n.async), n.xhrFields) for (u in n.xhrFields) s[u] = n.xhrFields[u];
          n.mimeType && s.overrideMimeType && s.overrideMimeType(n.mimeType),
          ...
          r = function (t, i) {
            ...
            h;
            try {
              if (r && (i || 4 === s.readyState)) if (r = e, a && (s.onreadystatechange = K.noop, Un && delete Wn[a]), i) 4 !== s.readyState && s.abort();
               else {
                u = s.status,
          ...
          n.async ? 4 === s.readyState ? setTimeout(r, 0)  : (a = ++Xn, Un && (Wn || (Wn = {
          }, K(t).unload(Un)), Wn[a] = r), s.onreadystatechange = r)  : r()
        },
        abort: function () {
          r && r(0, 1)
        }
      ...
      function (t, e) {
        ...
        if (o) {
          if (n = + o[2], r = o[3] || (K.cssNumber[t] ? '' : 'px'), 'px' !== r && u) {
            ...
            do s = s || '.5',
            u /= s,
            K.style(i.elem, t, u + r);
            while (s !== (s = i.cur() / a) && 1 !== s && --c)
          }
          i.unit = r,
          i.start = u,
          i.end = o[1] ? u + (o[1] + 1) * n : n
        }
        return i
      }
    ]
  ...
  K.fn.extend({
    ...
    stop: function (t, n, r) {
      ...
      return 'string' != typeof t && (r = n, n = t, t = e),
  ...
  K.fx.tick = function () {
    ...
    n = K.timers,
    r = 0;
    for (Vn = K.now(); n.length > r; r++) t = n[r],
    !t() && n[r] === t && n.splice(r--, 1);
    n.length || K.fx.stop(),
    Vn = e
  },
  ...
  K.expr && K.expr.filters && (K.expr.filters.animated = function (t) {
  ...
  K.offset = {
    ...
    setOffset: function (t, e, n) {
      ...
      s = K.css(t, 'top'),
      c = K.css(t, 'left'),
      l = ('absolute' === r || 'fixed' === r) && K.inArray('auto', [
        s,
        c
      ]) > - 1,
      f = {
      ...
      l ? (h = a.position(), i = h.top, o = h.left)  : (i = parseFloat(s) || 0, o = parseFloat(c) || 0),
      K.isFunction(e) && (e = e.call(t, n, u)),
      null != e.top && (f.top = e.top - u.top + i),
    ...
    position: function () {
      if (this[0]) {
        ...
        r = er.test(e[0].nodeName) ? {
         ...
         : e.offset();
        return n.top -= parseFloat(K.css(t, 'marginTop')) || 0,
        n.left -= parseFloat(K.css(t, 'marginLeft')) || 0,
        r.top += parseFloat(K.css(e[0], 'borderTopWidth')) || 0,
        r.left += parseFloat(K.css(e[0], 'borderLeftWidth')) || 0,
        {
          top: n.top - r.top,
          left: n.left - r.left
        }
  ...
  function d(t, e) {
    ...
    if (n.createSVGPoint) {
      ...
      return ya ? (r.x = e.pageX, r.y = e.pageY)  : (r.x = e.clientX, r.y = e.clientY),
    ...
    return [e.clientX - o.left - t.clientLeft,
    e.clientY - o.top - t.clientTop]
  }
  function p(t) {
    for (var e = - 1, n = t.length, r = [
    ]; n > ++e; ) r.push(t[e]);
    return r
  }
  function g(t) {
  ...
  function x(t, e) {
    ...
    return t = ca.ns.qualify(t),
    null == e ? t.local ? r : n : 'function' == typeof e ? t.local ? u : a : t.local ? o : i
  }
  function M(t) {
  ...
  function j(t, e) {
    for (var n = 0, r = t.length; r > n; n++) for (var i, o = t[n], a = 0, u = o.length; u > a; a++) (i = o[a]) && e(i, a, n);
    return t
  }
  function F(t) {
    return Ma(t, Da),
  ...
  function Y(t, e, n) {
    ...
    var o,
    a;
    return t = isNaN(t) ? 0 : 0 > (t %= 360) ? t + 360 : t,
    e = isNaN(e) ? 0 : 0 > e ? 0 : e > 1 ? 1 : e,
    n = 0 > n ? 0 : n > 1 ? 1 : n,
    a = 0.5 >= n ? n * (1 + e)  : n + e - n * e,
    o = 2 * n - a,
    ne(i(t + 120), i(t), i(t - 120))
  }
  function z(t) {
  ...
  function V(t, e, n) {
    return isNaN(t) && (t = 0),
    isNaN(e) && (e = 0),
    Z(n, Math.cos(t *= Ya) * e, Math.sin(t) * e)
  }
  function Z(t, e, n) {
    return new G(t, e, n)
  }
  ...
  function J(t, e, n) {
    ...
    r = Q(r) * Ia,
    o = Q(o) * Wa,
    ne(ee(3.2404542 * i - 1.5371385 * r - 0.4985314 * o), ee( - 0.969266 * i + 1.8760108 * r + 0.041556 * o), ee(0.0556434 * i - 0.2040259 * r + 1.0572252 * o))
  }
  function K(t, e, n) {
  ...
  function ee(t) {
    return Math.round(255 * (0.00304 >= t ? 12.92 * t : 1.055 * Math.pow(t, 1 / 2.4) - 0.055))
  }
  function ne(t, e, n) {
    return new re(t, e, n)
  }
  ...
  function ae(t, e, n) {
    ...
    u = a - o,
    s = (a + o) / 2;
    return u ? (i = 0.5 > s ? u / (a + o)  : u / (2 - a - o), r = t == a ? (e - n) / u + (n > e ? 6 : 0)  : e == a ? (n - t) / u + 2 : (t - e) / u + 4, r *= 60)  : (r = 0 / 0, i = s > 0 && 1 > s ? 0 : r),
    O(r, i, s)
  }
  function ue(t, e, n) {
    t = se(t),
    e = se(e),
    n = se(n);
    var r = te((0.4124564 * t + 0.3575761 * e + 0.1804375 * n) / Ba),
    i = te((0.2126729 * t + 0.7151522 * e + 0.072175 * n) / Ia),
    o = te((0.0193339 * t + 0.119192 * e + 0.9503041 * n) / Wa);
    return Z(116 * i - 16, 500 * (r - i), 200 * (i - o))
  }
  function se(t) {
    return 0.04045 >= (t /= 255) ? t / 12.92 : Math.pow((t + 0.055) / 1.055, 2.4)
  }
  function ce(t) {
    var e = parseFloat(t);
    ...
    n.parseRows = function (t, e) {
      function n() {
        ...
        if (34 === t.charCodeAt(e)) {
          for (var n = e; s > n++; ) if (34 === t.charCodeAt(n)) {
  ...
  function pe() {
    for (var t, e = Date.now(), n = Qa; n; ) t = e - n.then,
    t >= n.delay && (n.flush = n.callback(t)),
    n = n.next;
    var r = ge() - e;
  ...
  function ke(t, e) {
    if (!gu) {
      ...
      t *= Ya;
      var n = Math.cos(e *= Ya);
      vu += (n * Math.cos(t) - vu) / mu,
      yu += (n * Math.sin(t) - yu) / mu,
      xu += (Math.sin(e) - xu) / mu
    }
  }
  function Te() {
  ...
  function Fe(t) {
    ...
    Math.asin(Math.max( - 1, Math.min(1, t[2])))]
  }
  function qe(t, e) {
  ...
  function Oe(t, e, n, r, i) {
    ...
    if (t.forEach(function (t) {
      ...
      if (n) for (var u = 1, s = !n(a[0].point), c = a.length; c > u; ++u) a[u].entry = s = !s;
      for (var l, f, h, d = o[0]; ; ) {
        for (l = d; l.visited; ) if ((l = l.next) === d) return;
        f = l.points,
        i.lineStart();
        do {
          if (l.visited = l.other.visited = !0, l.entry) {
            if (l.subject) for (var u = 0; f.length > u; u++) i.point((h = f[u]) [0], h[1]);
  ...
  function Pe(t) {
    if (e = t.length) {
      for (var e, n, r = 0, i = t[0]; e > ++r; ) i.next = n = t[r],
      n.prev = i,
      i = n;
      i.next = n = t[0],
      n.prev = i
  ...
  function Ye(t, e, n) {
    return function (r) {
      ...
      function l() {
        ...
        i > 1 && 2 & e && n.push(n.pop().concat(n.shift())),
        f.push(n.filter(ze))
      }
      var f,
      h,
      ...
      v = {
        ...
        polygonEnd: function () {
          ...
          v.lineEnd = u,
          f = ca.merge(f),
          f.length ? Oe(f, Be, null, n, r)  : ( - Pa > h || p && - Pa > d) && (r.lineStart(), n(null, null, 1, r), r.lineEnd()),
          r.polygonEnd(),
          f = null
        },
        sphere: function () {
  ...
  function $e(t, e) {
    ...
    for (var n, r, i, o = 0, a = 0, u = t[0], s = u[0], c = u[1], l = Math.cos(c), f = Math.atan2(e * Math.sin(s) * l, Math.sin(c)), h = 1 - e * Math.cos(s) * l, d = f; n > ++o; ) u = t[o],
    l = Math.cos(c = u[1]),
    r = Math.atan2(e * Math.sin(s = u[0]) * l, Math.sin(c)),
    i = 1 - e * Math.cos(s) * l,
    Pa > Math.abs(h - 2) && Pa > Math.abs(i - 2) || (Pa > Math.abs(i) || Pa > Math.abs(h) || (Pa > Math.abs(Math.abs(r - f) - Oa) ? i + h > 2 && (a += 4 * (r - f))  : a += Pa > Math.abs(h - 2) ? 4 * (r - d)  : ((3 * Oa + r - f) % (2 * Oa) - Oa) * (h + i)), d = f, f = r, h = i);
    return a
  }
  function Be(t, e) {
  ...
  function Ie(t) {
    ...
    return {
      ...
      point: function (o, a) {
        var u = o > 0 ? Oa : - Oa,
        s = Math.abs(o - n);
        Pa > Math.abs(s - Oa) ? (t.point(n, r = (r + a) / 2 > 0 ? Oa / 2 : - Oa / 2), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(u, r), t.point(o, r), e = 0)  : i !== u && s >= Oa && (Pa > Math.abs(n - i) && (n -= i * Pa), Pa > Math.abs(o - u) && (o -= u * Pa), r = We(n, r, o, a), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(u, r), e = 0),
        t.point(n = o, r = a),
        i = u
      },
      lineEnd: function () {
    ...
    function n(t) {
      ...
      return {
        ...
        point: function (f, h) {
          ...
          if (!n && (c = s = g) && t.lineStart(), g !== s && (d = r(n, p), (qe(n, d) || qe(p, d)) && (p[0] += Pa, p[1] += Pa, g = e(p[0], p[1]))), g !== s) l = 0,
          g ? (t.lineStart(), d = r(p, n), t.point(d[0], d[1]))  : (d = r(n, p), t.point(d[0], d[1]), t.lineEnd()),
          n = d;
           else if (u && n && a ^ g) {
            var v;
  ...
  function Ve(t, e, n, r) {
    ...
    return function (s) {
      ...
      function l(t) {
        for (var e = 0, n = x.length, r = t[1], i = 0; n > i; ++i) for (var o = 1, a = x[i], u = a.length, s = a[0]; u > o; ++o) b = a[o],
        r >= s[1] ? b[1] > r && f(s, b, t) > 0 && ++e : r >= b[1] && 0 > f(s, b, t) && --e,
        s = b;
        return 0 !== e
      }
      function f(t, e, n) {
      ...
      function m() {
        y && (v(_, w), k && E && A.rejoin(), y.push(A.buffer())),
        D.point = p,
        E && s.lineEnd()
      }
      function v(t, e) {
        t = Math.max( - _u, Math.min(_u, t)),
        e = Math.max( - _u, Math.min(_u, e));
        var n = d(t, e);
        if (x && M.push([t,
        e]), N) _ = t,
        w = e,
      ...
      D = {
        ...
        polygonEnd: function () {
          s = C,
          (y = ca.merge(y)).length ? (s.polygonStart(), Oe(y, o, c, h, s), s.polygonEnd())  : l([t,
          e]) && (s.polygonStart(), s.lineStart(), h(null, null, 1, s), s.lineEnd(), s.polygonEnd()),
          y = x = M = null
        }
      };
      return D
  ...
  function Je(t) {
    function e(e) {
      ...
      function a(r, o) {
        ...
        o]),
        u = t(r, o);
        n(l, f, c, h, d, p, l = u[0], f = u[1], c = r, h = a[0], d = a[1], p = a[2], i, e),
        e.point(l, f)
      }
      function u() {
        g.point = r,
    ...
    function n(e, i, o, a, u, s, c, l, f, h, d, p, g, m) {
      ...
      if (x > 4 * r && g--) {
        ...
        A = N - i,
        D = y * C - v * A;
        (D * D / x > r || Math.abs((v * C + y * A) / x - 0.5) > 0.3) && (n(e, i, o, a, u, s, E, N, T, b /= w, M /= w, _, g, m), m.point(E, N), n(E, N, T, b, M, _, c, l, f, h, d, p, g, m))
      }
    }
    var r = 0.5,
    i = 16;
  ...
  function Qe(t) {
    ...
    function n(t) {
      return t = a.invert((t[0] - u) / l, (s - t[1]) / l),
      t && [t[0] * za,
      t[1] * za]
    }
    function r() {
    ...
    e.translate = function (t) {
      return arguments.length ? (f = + t[0], h = + t[1], r())  : [
        f,
        h
      ]
    },
    e.center = function (t) {
      return arguments.length ? (d = t[0] % 360 * Ya, p = t[1] % 360 * Ya, r())  : [
        d * za,
        p * za
      ]
    },
    e.rotate = function (t) {
      return arguments.length ? (g = t[0] % 360 * Ya, m = t[1] % 360 * Ya, v = t.length > 2 ? t[2] % 360 * Ya : 0, r())  : [
        g * za,
        m * za,
        v * za
      ]
  ...
  function tn(t, e) {
    return {
      point: function (n, r) {
        r = t(n * Ya, r * Ya),
        n = r[0],
        e.point(n > Oa ? n - 2 * Oa : - Oa > n ? n + 2 * Oa : n, r[1])
      },
      sphere: function () {
        e.sphere()
      },
  ...
  function an(t, e) {
    function n(t, e) {
      ...
      c = Math.sin(e),
      l = c * r + u * i;
      return [Math.atan2(s * o - l * a, u * r - c * i),
      Math.asin(Math.max( - 1, Math.min(1, l * o + s * a)))]
    }
    var r = Math.cos(t),
    i = Math.sin(t),
    o = Math.cos(e),
    ...
    return n.invert = function (t, e) {
      ...
      c = Math.sin(e),
      l = c * o - s * a;
      return [Math.atan2(s * o + c * a, u * r + l * i),
      Math.asin(Math.max( - 1, Math.min(1, l * r - u * i)))]
    },
    n
  }
  function un(t, e) {
    ...
    return function (i, o, a, u) {
      ...
      for (var s, c = a * e, l = i; a > 0 ? l > o : o > l; l -= c) u.point((s = Fe([n,
      - r * Math.cos(l),
      - r * Math.sin(l)])) [0], s[1])
    }
  }
  ...
  function dn(t, e, n, r) {
    ...
    p = h ? function (t) {
      ...
      i = n * c + e * f,
      a = n * o + e * u;
      return [Math.atan2(i, r) * za,
      Math.atan2(a, Math.sqrt(r * r + i * i)) * za]
    }
     : function () {
      return [t * za,
      e * za]
  ...
  function pn() {
    function t(t, i) {
      ...
      u = Math.abs((t *= Ya) - e),
      s = Math.cos(u);
      wu += Math.atan2(Math.sqrt((u = a * Math.sin(u)) * u + (u = r * o - n * a * s) * u), n * o + r * a * s),
      e = t,
      n = o,
      r = a
    }
  ...
  function gn(t) {
    ...
    return i.parallels = function (t) {
      return arguments.length ? r(e = t[0] * Oa / 180, n = t[1] * Oa / 180)  : [
        180 * (e / Oa),
        180 * (n / Oa)
      ]
    },
  ...
  function mn(t, e) {
    ...
    return n.invert = function (t, e) {
      var n = a - e;
      return [Math.atan2(t, n) / i,
      Math.asin((o - (t * t + n * n) * i * i) / (2 * i))]
    },
    n
  }
  function vn(t, e) {
    ...
    l = a / u,
    f = s / c,
    h = 0.5 * (l * f * (n[1] - i[1]) + f * (n[0] + r[0]) - l * (r[0] + i[0])) / (f - l),
    d = (0.5 * (n[0] + r[0]) - h) / l + 0.5 * (n[1] + r[1]),
    p = o[0] - h,
    g = o[1] - d,
    m = n[0] - h,
    v = n[1] - d,
  ...
  function Nn(t, e) {
    ...
    return o ? (n.invert = function (t, e) {
      ...
      return [Math.atan2(t, n) / o,
      2 * Math.atan(Math.pow(a / r, 1 / o)) - Oa / 2]
    }, n)  : An
  }
  function Cn(t, e) {
    function n(t, e) {
      var n = o - e;
      return [n * Math.sin(i * t),
      o - n * Math.cos(i * t)]
    }
    var r = Math.cos(t),
    ...
    return Pa > Math.abs(i) ? en : (n.invert = function (t, e) {
      var n = o - e;
      return [Math.atan2(t, n) / i,
      o - z(i) * Math.sqrt(t * t + n * n)]
    }, n)
  }
  function An(t, e) {
    return [t,
    Math.log(Math.tan(Oa / 4 + e / 2))]
  }
  function Dn(t) {
    var e,
    n = Ke(t),
  ...
  function Ln(t, e) {
    ...
    Math.atan2(Math.tan(e), Math.cos(t))]
  }
  function Hn(t) {
    function e(e) {
      function a() {
      ...
      ], f = - 1, h = e.length, d = le(n), p = le(r); h > ++f; ) i.call(this, s = e[f], f) ? l.push([ + d.call(this, s, f),
      + p.call(this, s, f)])  : l.length && (a(), l = [
      ]);
      return l.length && a(),
  ...
  function Pn(t) {
    for (var e = 0, n = t.length, r = t[0], i = [
      r[0],
      ',',
      r[1]
    ]; n > ++e; ) i.push('V', (r = t[e]) [1], 'H', r[0]);
    return i.join('')
  }
  function Yn(t) {
    for (var e = 0, n = t.length, r = t[0], i = [
  ...
  function Rn(t, e) {
    return 3 > t.length ? qn(t)  : t[0] + Bn((t.push(t[0]), t), In([t[t.length - 2]].concat(t, [
      t[1]
    ]), e))
  }
  function $n(t, e) {
  ...
  function Bn(t, e) {
    ...
    if (n && (r += 'Q' + (o[0] - 2 * a[0] / 3) + ',' + (o[1] - 2 * a[1] / 3) + ',' + o[0] + ',' + o[1], i = t[1], s = 2), e.length > 1) {
      ...
      for (var c = 2; e.length > c; c++, s++) o = t[s],
      u = e[c],
  ...
  function In(t, e) {
    for (var n, r = [
    ], i = (1 - e) / 2, o = t[0], a = t[1], u = 1, s = t.length; s > ++u; ) n = o,
    o = a,
    a = t[u],
    r.push([i * (a[0] - n[0]),
    i * (a[1] - n[1])]);
  ...
  function Un(t) {
    ...
    o.push(e[0]),
    a.push(e[1]);
    for (n.push(Zn(Ou, o) + ',' + Zn(Ou, a)), --r; i > ++r; ) e = t[r],
    o.shift(),
    o.push(e[0]),
    a.shift(),
    a.push(e[1]),
  ...
  function Xn(t) {
    for (var e, n, r = - 1, i = t.length, o = i + 4, a = [
    ], u = [
    ]; 4 > ++r; ) n = t[r % i],
    a.push(n[0]),
    u.push(n[1]);
  ...
  function Vn(t, e) {
    var n = t.length - 1;
    if (n) for (var r, i, o = t[0][0], a = t[0][1], u = t[n][0] - o, s = t[n][1] - a, c = - 1; n >= ++c; ) r = t[c],
    i = c / n,
    r[0] = e * r[0] + (1 - e) * (o + i * u),
    r[1] = e * r[1] + (1 - e) * (a + i * s);
    return Wn(t)
  ...
  function Kn(t) {
    for (var e = 0, n = t.length - 1, r = [
    ], i = t[0], o = t[1], a = r[0] = Jn(i, o); n > ++e; ) r[e] = (a + (a = Jn(i = o, o = t[e + 1]))) / 2;
    return r[e] = a,
    r
  }
  function Qn(t) {
    for (var e, n, r, i, o = [
    ], a = Kn(t), u = - 1, s = t.length - 1; s > ++u; ) e = Jn(t[u], t[u + 1]),
    0.000001 > Math.abs(e) ? a[u] = a[u + 1] = 0 : (n = a[u] / e, r = a[u + 1] / e, i = n * n + r * r, i > 9 && (i = 3 * e / Math.sqrt(i), a[u] = i * n, a[u + 1] = i * r));
    for (u = - 1; s >= ++u; ) i = (t[Math.min(s, u + 1)][0] - t[Math.max(0, u - 1)][0]) / (6 * (1 + a[u] * a[u])),
    o.push([i || 0,
    a[u] * i || 0]);
    return o
  }
  ...
  function ir(t, e) {
    ...
    i = {
      bisect: function (t, e) {
        ...
        o = r > 0 ? r : - r,
        a = i > 0 ? i : - i;
        return n.c = t.x * r + t.y * i + 0.5 * (r * r + i * i),
        o > a ? (n.a = 1, n.b = i / r, n.c /= r)  : (n.b = 1, n.a = r / i, n.c /= i),
        n
      },
      ...
      rightOf: function (t, e) {
        ...
        if (1 === n.a) {
          ...
          if (!i && 0 > n.b || i && n.b >= 0 ? s = u = o >= n.b * a : (s = e.x + e.y * n.b > n.c, 0 > n.b && (s = !s), s || (u = 1)), !u) {
            ...
            s = n.b * (a * a - o * o) < c * o * (1 + 2 * a / c + n.b * n.b),
            0 > n.b && (s = !s)
          }
        } else {
          var l = n.c - n.a * e.x,
    ...
    o = {
      ...
      nextEvent: function (t) {
        for (var e = 0, n = o.list, r = n.length; r > e; ++e) if (n[e] == t) return n[e + 1];
        return null
      },
      min: function () {
        var t = o.list[0];
    ...
    for (var a, u, s, c, l, f, h, d, p, g, m, v, y, x = n.list.shift(); ; ) if (o.empty() || (a = o.min()), x && (o.empty() || x.y < a.y || x.y == a.y && x.x < a.x)) u = r.leftBound(x),
    s = r.right(u),
    h = r.rightRegion(u),
    v = i.bisect(h, x),
    f = r.createHalfEdge(v, 'l'),
    r.insert(u, f),
    g = i.intersect(u, f),
    g && (o.del(u), o.insert(u, g, i.distance(g, x))),
    u = f,
    f = r.createHalfEdge(v, 'r'),
    r.insert(u, f),
    g = i.intersect(f, s),
    g && o.insert(f, g, i.distance(g, x)),
    x = n.list.shift();
     else {
      if (o.empty()) break;
      u = o.extractMin(),
      ...
      v = i.bisect(h, d),
      f = r.createHalfEdge(v, y),
      r.insert(c, f),
      i.endPoint(v, Pu[y], m),
      g = i.intersect(c, f),
      g && (o.del(c), o.insert(c, g, i.distance(g, h))),
      g = i.intersect(f, l),
  ...
  function sr(t, e, n, r, i, o) {
    if (!t(e, n, r, i, o)) {
      ...
      u = 0.5 * (r + o),
      s = e.nodes;
      s[0] && sr(t, s[0], n, r, a, u),
      s[1] && sr(t, s[1], a, r, i, u),
      s[2] && sr(t, s[2], n, u, a, o),
      s[3] && sr(t, s[3], a, u, i, o)
    }
  }
  function cr(t, e) {
    t = ca.rgb(t),
  ...
  function lr(t) {
    ...
    this.rotate = (r ? Math.atan2(e[1], e[0])  : Math.atan2( - n[0], n[1])) * za,
    this.translate = [
      t.e,
      t.f
    ],
    ...
    this.skew = o ? Math.atan2(i, o) * za : 0
  }
  function fr(t, e) {
  ...
  function gr(t, e) {
    ...
    c != l ? (c - l > 180 ? l += 360 : l - c > 180 && (c += 360), i.push({
    ...
    d[0] != p[0] || d[1] != p[1] ? (n = r.push(r.pop() + 'scale(', null, ',', null, ')'), i.push({
      i: n - 4,
      x: pr(d[0], p[0])
    }, {
      i: n - 2,
  ...
  function vr(t, e) {
    ...
    for (t += '', e += '', zu.lastIndex = 0, r = 0; n = zu.exec(e); ++r) n.index && c.push(e.substring(u, s = n.index)),
    l.push({
      i: c.length,
      x: n[0]
    }),
    c.push(null),
    u = zu.lastIndex;
    for (e.length > u && c.push(e.substring(u)), r = 0, o = l.length; (n = zu.exec(t)) && o > r; ++r) if (a = l[r], a.x == n[0]) {
      if (a.i) if (null == c[a.i + 1]) for (c[a.i - 1] += a.x, c.splice(a.i, 1), i = r + 1; o > i; ++i) l[i].i--;
    ...
    for (; o > r; ) a = l.pop(),
    null == c[a.i + 1] ? c[a.i] = a.x : (c[a.i] = a.x + c[a.i + 1], c.splice(a.i + 1, 1)),
    o--;
  ...
  function wr(t) {
    return function (e) {
      return 0.5 * (0.5 > e ? t(2 * e)  : 2 - t(2 - 2 * e))
    }
  }
  function kr(t) {
    return t * t
  ...
  function Dr(t, e) {
    var n;
    return 2 > arguments.length && (e = 0.45),
    arguments.length ? n = e / (2 * Oa) * Math.asin(1 / t)  : (t = 1, n = e / 4),
    function (r) {
  ...
  function zr(t) {
    for (var e = t.source, n = t.target, r = $r(e, n), i = [
      e
    ]; e !== r; ) e = e.parent,
    i.push(e);
  ...
  function $r(t, e) {
    if (t === e) return t;
    for (var n = Rr(t), r = Rr(e), i = n.pop(), o = r.pop(), a = null; i === o; ) a = i,
    i = n.pop(),
    o = r.pop();
    return a
  }
  ...
  function Xr(t, e, n) {
    var r = 0,
    i = 0;
    if (t.charge = 0, !t.leaf) for (var o, a = t.nodes, u = a.length, s = - 1; u > ++s; ) o = a[s],
    null != o && (Xr(o, e, n), t.charge += o.charge, r += o.charge * o.cx, i += o.charge * o.cy);
    if (t.point) {
  ...
  function Vr(t, e) {
    return ca.rebind(t, e, 'sort', 'children', 'value'),
    t.nodes = t,
    t.links = Kr,
    t
  }
  ...
  function di(t, e) {
    var n = t.children;
    if (n && (i = n.length)) for (var r, i, o = - 1; i > ++o; ) e(r = di(n[o], e), t) > 0 && (t = r);
    return t
  }
  function pi(t, e) {
    return t.x - e.x
  ...
  function vi(t, e) {
    function n(t, r) {
      var i = t.children;
      if (i && (a = i.length)) for (var o, a, u = null, s = - 1; a > ++s; ) o = i[s],
      n(o, u),
      u = o;
      e(t, r)
    }
  ...
  function yi(t) {
    for (var e, n = 0, r = 0, i = t.children, o = i.length; --o >= 0; ) e = i[o]._tree,
    e.prelim += n,
    e.mod += n,
  ...
  function Ti(t) {
    ...
    if ((n = t.children) && (c = n.length)) {
      ...
      h = 1 / 0,
      d = - 1 / 0;
      if (n.forEach(Si), r = n[0], r.x = - r.r, r.y = 0, e(r), c > 1 && (i = n[1], i.x = i.r, i.y = 0, e(i), c > 2)) for (o = n[2], Ci(r, i, o), e(o), _i(r, o), r._pack_prev = o, _i(o, i), i = r._pack_next, a = 3; c > a; a++) {
        Ci(r, i, o = n[a]);
        var p = 0,
        g = 1,
        m = 1;
        for (u = i._pack_next; u !== i; u = u._pack_next, g++) if (ki(u, o)) {
          p = 1;
          break
        }
        if (1 == p) for (s = r._pack_prev; s !== u._pack_prev && !ki(s, o); s = s._pack_prev, m++);
      ...
      o.x -= v,
      o.y -= y,
      x = Math.max(x, o.r + Math.sqrt(o.x * o.x + o.y * o.y));
      t.r = x,
      n.forEach(Ei)
    }
  }
  ...
  function Ni(t, e, n, r) {
    var i = t.children;
    if (t.x = e += r * t.x, t.y = n += r * t.y, t.r *= r, i) for (var o = - 1, a = i.length; a > ++o; ) Ni(i[o], e, n, r)
  }
  function Ci(t, e, n) {
    var r = t.r + n.r,
    i = e.x - t.x,
  ...
  function zi(t, e, n, r) {
    ...
    for (t[u] < t[0] && (t = t.slice().reverse(), e = e.slice().reverse()); u >= ++a; ) i.push(n(t[a - 1], t[a])),
    o.push(r(e[a - 1], e[a]));
    return function (e) {
  ...
  function Ii(t, e) {
    ...
    o = e / r * i;
    return 0.15 >= o ? i *= 10 : 0.35 >= o ? i *= 5 : 0.75 >= o && (i *= 2),
  ...
  function Ui(t, e, n) {
    var r = - Math.floor(Math.log(Ii(t, e) [2]) / Math.LN10 + 0.01);
  ...
  function Xi(t, e, n, r) {
    ...
    i.nice = function () {
      return t.domain(Yi(t.domain(), Ki(e))),
      i
    },
    i.ticks = function () {
      var i = qi(t.domain()),
      ...
      if (i.every(isFinite)) {
        ...
        l = r(i[1]),
        f = e % 1 ? 2 : e;
        if (n === Gi) for (o.push( - Math.pow(e, - u)); s > u++; ) for (var h = f - 1; h > 0; h--) o.push( - Math.pow(e, - u) * h);
         else {
          for (; s > u; u++) for (var h = 1; f > h; h++) o.push(Math.pow(e, u) * h);
          o.push(Math.pow(e, u))
        }
        for (u = 0; c > o[u]; u++);
    ...
    i.tickFormat = function (t, o) {
      ...
      var a,
      u = Math.log(e),
      s = Math.max(0.1, t / i.ticks().length),
  ...
  function eo(t, e) {
    ...
    n.rangePoints = function (i, o) {
      ...
      return a = r(2 > t.length ? (s + c) / 2 : s + l * o / 2, l),
      u = 0,
      e = {
        t: 'rangePoints',
        a: arguments
  ...
  function ro(t, e, n) {
    ...
    return r.domain = function (n) {
      return arguments.length ? (t = + n[0], e = + n[n.length - 1], i())  : [
        t,
        e
      ]
    },
  ...
  function lo(t) {
    for (var e, n, r, i = - 1, o = t.length; o > ++i; ) e = t[i],
    n = e[0],
    r = e[1] + ts,
    e[0] = n * Math.cos(r),
    e[1] = n * Math.sin(r);
  ...
  function fo(t) {
    function e(e) {
      ...
      ], y = - 1, x = e.length, b = le(n), M = le(i), _ = n === r ? function () {
        return d
      }
       : le(r), w = i === o ? function () {
        return p
      }
       : le(o); x > ++y; ) a.call(this, h = e[y], y) ? (m.push([d = + b.call(this, h, y),
      p = + M.call(this, h, y)]), v.push([ + _.call(this, h, y),
      + w.call(this, h, y)]))  : m.length && (s(), m = [
      ], v = [
      ]);
      return m.length && s(),
  ...
  function _o(t, e, n, r) {
    ...
    if (!a) {
      ...
      ca.timer(function (r) {
        ...
        function c() {
          return --o.count ? delete o[n] : delete t.__transition__,
          1
        }
        var l = t.__data__,
        f = a.ease,
  ...
  function To(t, e, n) {
    if (r = [
      ...
      for (var r, i, o, a = qi(t.domain()), u = - 1, s = e.length, c = (e[1] - e[0]) / ++n; s > ++u; ) for (i = n; --i > 0; ) (o = + e[u] - i * c) >= a[0] && r.push(o);
  ...
  function Eo(t, e, n) {
    ...
    function a(t, r, o) {
      ...
      if (o > 1) for (; r > a; ) n(a) % o || u.push(new Date( + a)),
      e(a, 1);
       else for (; r > a; ) u.push(new Date( + a)),
      e(a, 1);
      return u
    }
    function u(t, e, n) {
  ...
  function Ko(t, e, n) {
    ...
    r.ticks = function (n, i) {
      ...
      if ('function' != typeof n) {
        ...
        Math.log(u / Fs[s - 1]) < Math.log(Fs[s] / u) && --s,
        n = e[s],
        i = n[1],
        n = n[0].range
      }
  ...
  ca.sum = function (t, e) {
    ...
    i = t.length,
    o = - 1;
    if (1 === arguments.length) for (; i > ++o; ) isNaN(n = + t[o]) || (r += n);
     else for (; i > ++o; ) isNaN(n = + e.call(t, t[o], o)) || (r += n);
    return r
  },
  ca.mean = function (e, n) {
    ...
    a = - 1,
    u = 0;
    if (1 === arguments.length) for (; i > ++a; ) t(r = e[a]) && (o += (r - o) / ++u);
     else for (; i > ++a; ) t(r = n.call(e, e[a], a)) && (o += (r - o) / ++u);
    return u ? o : void 0
  },
  ...
  ca.median = function (e, n) {
    return arguments.length > 1 && (e = e.map(n)),
    e = e.filter(t),
    e.length ? ca.quantile(e.sort(ca.ascending), 0.5)  : void 0
  },
  ...
  ca.bisectLeft = ga.left,
  ca.bisect = ca.bisectRight = ga.right,
  ca.shuffle = function (t) {
    for (var e, n, r = t.length; r; ) n = 0 | Math.random() * r--,
    e = t[r],
    t[r] = t[n],
    t[n] = e;
    return t
  ...
  ca.permute = function (t, e) {
    for (var n = [
    ], r = - 1, i = e.length; i > ++r; ) n[r] = t[e[r]];
    return n
  },
  ca.zip = function () {
    if (!(i = arguments.length)) return [];
    for (var t = - 1, n = ca.min(arguments, e), r = Array(n); n > ++t; ) for (var i, o = - 1, a = r[t] = Array(i); i > ++o; ) a[o] = arguments[o][t];
    return r
  },
  ...
  ca.range = function (t, e, r) {
    ...
    a = n(Math.abs(r)),
    u = - 1;
    if (t *= a, e *= a, r *= a, 0 > r) for (; (i = t + r * ++u) > e; ) o.push(i / a);
     else for (; e > (i = t + r * ++u); ) o.push(i / a);
    return o
  },
  ca.map = function (t) {
    var e = new i;
  ...
  ca.nest = function () {
    function t(e, u, s) {
      ...
      for (var c, l, f, h, d = - 1, p = u.length, g = a[s++], m = new i; p > ++d; ) (h = m.get(c = g(l = u[d]))) ? h.push(l)  : m.set(c, [
        l
      ]);
  ...
  ca.set = function (t) {
    var e = new o;
    if (t) for (var n = 0; t.length > n; n++) e.add(t[n]);
    return e
  },
  r(o, {
    has: function (t) {
  ...
  ca.touches = function (t, e) {
    return 2 > arguments.length && (e = l().touches),
    e ? xa(e).map(function (e) {
      var n = d(t, e);
  ...
  ca.behavior.drag = function () {
    ...
    function e() {
      ...
      function i() {
        ...
        d && (c(), ca.event.target === s && f(p, 'click')),
        p.on(null != l ? 'touchmove.drag-' + l : 'mousemove.drag', null).on(null != l ? 'touchend.drag-' + l : 'mouseup.drag', null)
      }
      var o,
      a = this,
      u = n.of(a, arguments),
  ...
  Ea.selectAll = function (t) {
    ...
    for (var i = - 1, o = this.length; o > ++i; ) for (var a = this[i], u = - 1, s = a.length; s > ++u; ) (n = a[u]) && (r.push(e = xa(t.call(n, n.__data__, u))), e.parentNode = n);
    return m(r)
  };
  var Na = {
  ...
  ca.ns = {
    ...
    qualify: function (t) {
      var e = t.indexOf(':'),
      n = t;
      return e >= 0 && (n = t.substring(0, e), t = t.substring(e + 1)),
      Na.hasOwnProperty(n) ? {
        space: Na[n],
        local: t
      }
  ...
  Ea.classed = function (t, e) {
    if (2 > arguments.length) {
      if ('string' == typeof t) {
        ...
        i = - 1;
        if (e = n.classList) {
          for (; r > ++i; ) if (!e.contains(t[i])) return !1
        } else for (e = n.getAttribute('class'); r > ++i; ) if (!_(t[i]).test(e)) return !1;
        return !0
      }
  ...
  Ea.data = function (t, e) {
    function n(t, n) {
      ...
      if (e) {
        ...
        for (r = - 1; u > ++r; ) m = e.call(o = t[r], o.__data__, r),
        v.has(m) ? g[r] = o : v.set(m, o),
        x.push(m);
        for (r = - 1; f > ++r; ) m = e.call(n, a = n[r], r),
        (o = v.get(m)) ? (d[r] = o, o.__data__ = a)  : y.has(m) || (p[r] = E(a)),
        y.set(m, a),
        v.remove(m);
        ...
        for (r = - 1; h > ++r; ) o = t[r],
        a = n[r],
        o ? (o.__data__ = a, d[r] = o)  : p[r] = E(a);
        for (; f > r; ++r) p[r] = E(n[r]);
        for (; u > r; ++r) g[r] = t[r]
      }
      p.update = d,
      p.parentNode = d.parentNode = g.parentNode = t.parentNode,
      s.push(p),
      c.push(d),
      l.push(g)
    }
    ...
    c = m([]),
    l = m([]);
    if ('function' == typeof t) for (; u > ++a; ) n(r = this[a], t.call(r, r.parentNode.__data__, a));
     else for (; u > ++a; ) n(r = this[a], t);
  ...
  Ea.order = function () {
    for (var t = - 1, e = this.length; e > ++t; ) for (var n, r = this[t], i = r.length - 1, o = r[i]; --i >= 0; ) (n = r[i]) && (o && o !== n.nextSibling && o.parentNode.insertBefore(n, o), o = n);
    return this
  },
  Ea.sort = function (t) {
  ...
  ca.selection.enter = F,
  ca.selection.enter.prototype = Da,
  Da.append = Ea.append,
  Da.insert = Ea.insert,
  Da.empty = Ea.empty,
  Da.node = Ea.node,
  ...
  Ea.transition = function () {
    ...
    for (var o = - 1, a = this.length; a > ++o; ) {
      ...
      for (var u = this[o], s = - 1, c = u.length; c > ++s; ) (e = u[s]) && _o(e, s, n, i),
      t.push(e)
    }
    return xo(r, n)
  },
  ca.select = function (t) {
    var e = [
      'string' == typeof t ? _a(t, la)  : t
    ];
    return e.parentNode = ka,
    m([e])
  },
  ...
  ca.behavior.zoom = function () {
    ...
    function u() {
      ...
      function n() {
        ...
        s && ca.event.target === u && f(l, 'click.zoom')
      }
      var r = this,
      o = S.of(r, arguments),
      u = ca.event.target,
    ...
    function s() {
      m || (m = e(ca.mouse(this))),
      r(Math.pow(2, 0.002 * Ha()) * k),
      i(ca.mouse(this), m),
      a(S.of(this, arguments))
    }
    function l() {
      m = null
    }
    function d() {
      ...
      r(Math.pow(2, ca.event.shiftKey ? Math.ceil(o) - 1 : Math.floor(o) + 1)),
      i(t, n),
      a(S.of(this, arguments))
    }
    function p() {
    ...
    t.x = function (e) {
      return arguments.length ? (x = e, y = e.copy(), w = [
        0,
        0
      ], k = 1, t)  : x
    },
    t.y = function (e) {
      return arguments.length ? (M = e, b = e.copy(), w = [
        0,
        0
      ], k = 1, t)  : M
    },
  ...
  qa.brighter = function (t) {
    return t = Math.pow(0.7, arguments.length ? t : 1),
    O(this.h, this.s, this.l / t)
  },
  qa.darker = function (t) {
    return t = Math.pow(0.7, arguments.length ? t : 1),
    O(this.h, this.s, t * this.l)
  },
  qa.rgb = function () {
  ...
  Xa.darker = function (t) {
    return t = Math.pow(0.7, arguments.length ? t : 1),
    ne(Math.floor(t * this.r), Math.floor(t * this.g), Math.floor(t * this.b))
  },
  Xa.hsl = function () {
  ...
  ca.xhr = function (t, e, n) {
    ...
    i.header = function (t, e) {
      ...
      2 > arguments.length ? a[t] : (null == e ? delete a[t] : a[t] = e + '', i)
    },
    ...
    [
      ...
      i[t] = function () {
        return i.send.apply(i, [
          t
        ].concat(xa(arguments)))
      }
    }),
    i.send = function (n, r, o) {
      if (2 === arguments.length && 'function' == typeof r && (o = r, r = null), s.open(n, t, !0), null == e || 'accept' in a || (a.accept = e + ',*/*'), s.setRequestHeader) for (var u in a) s.setRequestHeader(u, a[u]);
  ...
  ca.csv = de(',', 'text/csv'),
  ca.tsv = de('\t', 'text/tab-separated-values');
  var Za,
  Ga,
  Ja = 0,
  Ka = {
  ...
  ca.formatPrefix = function (t, e) {
    var n = 0;
    return t && (0 > t && (t *= - 1), e && (t = ca.round(t, ve(t, e))), n = 1 + Math.floor(1e-12 + Math.log(t) / Math.LN10), n = Math.max( - 24, Math.min(24, 3 * Math.floor((0 >= n ? n + 1 : n - 1) / 3)))),
    iu[8 + n / 3]
  },
  ...
  ca.format = function (t) {
    ...
    '#' === o && (o = ''),
    'r' != l || c || (l = 'g'),
    null != c && ('g' == l ? c = Math.max(1, Math.min(21, c))  : ('e' == l || 'f' == l) && (c = Math.max(0, Math.min(20, c)))),
    l = au.get(l) || ye;
    var p = a && s;
    return function (t) {
      if (d && t % 1) return '';
      ...
      eu && t.replace('.', eu),
      e += o,
      ('<' === r ? e + t + v : '>' === r ? v + e + t : '^' === r ? v.substring(0, m >>= 1) + e + t + v.substring(m)  : e + (p ? t : v + t)) + h
  }
};
var ou = /(?:([^{])?([<>=^]))?([+\- ])?(#)?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i,
au = ca.map({
...
if (ru) {
  var su = ru.length;
  uu = function (t) {
    for (var e = t.lastIndexOf('.'), n = e >= 0 ? '.' + t.substring(e + 1)  : (e = t.length, ''), r = [
    ], i = 0, o = ru[0]; e > 0 && o > 0; ) r.push(t.substring(e -= o, e + o)),
    o = ru[i = (i + 1) % su];
...
lu = {
  ...
  MultiPoint: function (t, e) {
    for (var n, r = t.coordinates, i = - 1, o = r.length; o > ++i; ) n = r[i],
    e.point(n[0], n[1])
  },
...
pu = {
  ...
  polygonEnd: function () {
    ...
    fu += 0 > t ? 4 * Oa + t : t,
    pu.lineStart = pu.lineEnd = pu.point = A
  }
};
ca.geo.bounds = we(fe),
ca.geo.centroid = function (t) {
  ...
  ca.geo.stream(t, bu);
  var e;
  return mu && Math.abs(e = Math.sqrt(vu * vu + yu * yu + xu * xu)) > Pa ? [
    Math.atan2(yu, vu) * za,
    Math.asin(Math.max( - 1, Math.min(1, xu / e))) * za
  ] : void 0
};
var gu,
mu,
...
Mu = Ye(je, Ie, Ue),
_u = 1000000000;
ca.geo.projection = Ke,
ca.geo.projectionMutator = Qe,
(ca.geo.equirectangular = function () {
  return Ke(en)
}).raw = en.invert = en,
ca.geo.rotation = function (t) {
  function e(e) {
    return e = t(e[0] * Ya, e[1] * Ya),
    e[0] *= za,
    e[1] *= za,
    e
  }
  return t = nn(t[0] % 360 * Ya, t[1] * Ya, t.length > 2 ? t[2] * Ya : 0),
  e.invert = function (e) {
    return e = t.invert(e[0] * Ya, e[1] * Ya),
    e[0] *= za,
    e[1] *= za,
    e
  },
...
ca.geo.graticule = function () {
  ...
  t.outline = function () {
    return {
      type: 'Polygon',
      coordinates: [
        h(o).concat(d(s).slice(1), h(i).reverse().slice(1), d(c).reverse().slice(1))
      ]
    }
  },
  t.extent = function (e) {
  ...
  t.majorStep = function (e) {
    return arguments.length ? (m = + e[0], v = + e[1], t)  : [
      m,
      v
    ]
  },
  t.minorStep = function (e) {
    return arguments.length ? (p = + e[0], g = + e[1], t)  : [
      p,
      g
    ]
  },
...
ca.geo.albersUsa = function () {
  ...
  r,
  i,
  o = ca.geo.conicEqualArea().rotate([98,
  0]).center([0,
  38]).parallels([29.5,
  45.5]),
  a = ca.geo.conicEqualArea().rotate([160,
  0]).center([0,
  60]).parallels([55,
  65]),
  u = ca.geo.conicEqualArea().rotate([160,
  0]).center([0,
  20]).parallels([8,
  18]),
  s = ca.geo.conicEqualArea().rotate([60,
  0]).center([0,
  10]).parallels([8,
  18]);
  ...
  t.scale = function (e) {
    return arguments.length ? (o.scale(e), a.scale(0.6 * e), u.scale(e), s.scale(1.5 * e), t.translate(o.translate()))  : o.scale()
  },
  t.translate = function (e) {
    ...
    a.translate([l - 0.4 * c,
    f + 0.17 * c]),
    u.translate([l - 0.19 * c,
    f + 0.2 * c]),
    s.translate([l + 0.58 * c,
    f + 0.43 * c]),
    n = vn(a, [
      [ - 180,
      50],
...
Eu = {
  ...
  polygonEnd: function () {
    Eu.lineStart = Eu.lineEnd = Eu.point = A,
    Tu += Math.abs(Su / 2)
  }
},
Nu = {
...
ca.geo.path = function () {
  function t(t) {
    return t && ca.geo.stream(t, r(i.pointRadius('function' == typeof o ? + o.apply(this, arguments)  : o))),
    i.result()
  }
  var e,
  n,
  ...
  return t.area = function (t) {
    return Tu = 0,
    ca.geo.stream(t, r(Eu)),
    Tu
  },
  t.centroid = function (t) {
    return gu = vu = yu = xu = 0,
    ca.geo.stream(t, r(Nu)),
    xu ? [
      vu / xu,
      yu / xu
    ] : void 0
...
ca.geo.albers = function () {
  return ca.geo.conicEqualArea().parallels([29.5,
  45.5]).rotate([98,
  0]).center([0,
  38]).scale(1000)
};
...
(ca.geo.conicConformal = function () {
  return gn(Nn)
}).raw = Nn,
(ca.geo.conicEquidistant = function () {
  return gn(Cn)
}).raw = Cn;
...
An.invert = function (t, e) {
  return [t,
  2 * Math.atan(Math.exp(e)) - Oa / 2]
},
...
Ln.invert = function (t, e) {
  return [Math.atan2(B(t), Math.cos(e)),
  $(Math.sin(e) / I(t))]
},
...
ca.geom.hull = function (t) {
  function e(t) {
    ...
    ]; v > o; ++o) e.push([ + g.call(this, i = t[o], o),
    + m.call(this, i, o)]);
    ...
    for (p = b.length; y > a; ++a) if (!(0 > x[a].index)) {
...
ca.geom.polygon = function (t) {
  ...
  t.centroid = function (e) {
    ...
    u = 0,
    s = t[o - 1];
    for (arguments.length || (e = - 1 / (6 * t.area())); o > ++i; ) n = s,
    s = t[i],
    r = n[0] * s[1] - s[0] * n[1],
    a += (n[0] + s[0]) * r,
    u += (n[1] + s[1]) * r;
  ...
  t.clip = function (e) {
    for (var n, r, i, o, a, u, s = - 1, c = t.length, l = t[c - 1]; c > ++s; ) {
      for (n = e.slice(), e.length = 0, o = t[s], a = n[(i = n.length) - 1], r = - 1; i > ++r; ) u = n[r],
      nr(u, l, o) ? (nr(a, l, o) || e.push(rr(a, u, l, o)), e.push(u))  : nr(a, l, o) && e.push(rr(a, u, l, o)),
      a = u;
      l = o
    }
    return e
...
ca.geom.delaunay = function (t) {
  ...
  e.forEach(function (e, r) {
    ...
    for (var u = 0, s = e.length - 1; s > u; u++) n.push([i,
    e[u],
    e[u + 1]])
  }),
  n
...
ca.geom.voronoi = function (t) {
  function e(t) {
    ...
    ], a = 0; l > a; ++a) e.push([ + s.call(this, r = t[a], a),
    + c.call(this, r, a)]);
    if (ir(e, function (t) {
      var e,
      n,
      ...
      o,
      a;
      1 === t.a && t.b >= 0 ? (e = t.ep.r, n = t.ep.l)  : (e = t.ep.l, n = t.ep.r),
      1 === t.a ? (o = e ? e.y : - f, r = t.c - t.b * o, a = n ? n.y : f, i = t.c - t.b * a)  : (r = e ? e.x : - f, o = t.c - t.a * r, i = n ? n.x : f, a = t.c - t.a * i);
      var s = [
        r,
        o
      ],
      ...
      u[t.region.l.index].push(s, c),
      u[t.region.r.index].push(s, c)
  ...
  return arguments.length ? e(t)  : (e.x = function (t) {
    ...
    return arguments.length ? (null == t ? n = null : (r = [
      + t[0],
      + t[1]
    ], n = ca.geom.polygon([[0,
    0],
    ...
    l = t.length;
    if (s === jn && c === Fn) e = t;
     else for (r = 0; l > r; ++r) e.push([ + s.call(this, n = t[r], r),
    + c.call(this, n, r)]);
...
ca.geom.quadtree = function (t, e, n, r, i) {
  function o(t) {
    function o(t, e, n, r, i, o, a, u) {
      if (!isNaN(n) && !isNaN(r)) if (t.leaf) {
        var s = t.x,
        l = t.y;
        if (null != s) if (0.01 > Math.abs(s - n) + Math.abs(l - r)) c(t, e, n, r, i, o, a, u);
         else {
          var f = t.point;
    ...
    v = r,
    y = i;
     else if (v = y = - (g = m = 1 / 0), f = [
    ], h = [
    ], p = t.length, a) for (d = 0; p > d; ++d) l = t[d],
    g > l.x && (g = l.x),
    m > l.y && (m = l.y),
    l.x > v && (v = l.x),
    l.y > y && (y = l.y),
  ...
  return (a = arguments.length) ? (u = or, s = ar, 3 === a && (i = n, r = e, n = e = 0), o(t))  : (o.x = function (t) {
    ...
    return arguments.length ? (null == t ? e = n = r = i = null : (e = n = 0, r = + t[0], i = + t[1]), o)  : null == e ? null : [
      r,
      i
    ]
  }, o)
...
ca.interpolateNumber = pr,
ca.interpolateTransform = gr,
ca.interpolateObject = mr,
ca.interpolateString = vr;
var zu = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g;
ca.interpolate = yr,
ca.interpolators = [
  function (t, e) {
...
ca.ease = function (t) {
  ...
  return n = $u.get(n) || Ru,
  r = Bu.get(r) || fe,
  Mr(r(n.apply(null, Array.prototype.slice.call(arguments, 1))))
},
ca.interpolateHcl = jr,
ca.interpolateHsl = Fr,
ca.interpolateLab = qr,
ca.interpolateRound = Or,
ca.layout = {
},
ca.layout.bundle = function () {
  return function (t) {
    for (var e = [
    ], n = - 1, r = t.length; r > ++n; ) e.push(zr(t[n]));
    return e
  }
},
...
ca.layout.force = function () {
  ...
  return u.tick = function () {
    ...
    x = h.x - f.x,
    b = h.y - f.y,
    (g = x * x + b * b) && (g = r * o[n] * ((g = Math.sqrt(g)) - i[n]) / g, x *= g, b *= g, h.x -= x * (y = f.weight / (h.weight + f.weight)), h.y -= b * y, f.x += x * (y = 1 - y), f.y += b * y);
    if ((y = r * p) && (x = c[0] / 2, b = c[1] / 2, n = - 1, y)) for (; M > ++n; ) u = m[n],
    u.x += (x - u.x) * y,
    u.y += (b - u.y) * y;
    if (d) for (Xr(e = ca.geom.quadtree(m), r, a), n = - 1; M > ++n; ) (u = m[n]).fixed || e.visit(t(u));
    for (n = - 1; M > ++n; ) u = m[n],
    u.fixed ? (u.x = u.px, u.y = u.py)  : (u.x -= (u.px - (u.px = u.x)) * l, u.y -= (u.py - (u.py = u.y)) * l);
    s.tick({
      type: 'tick',
      alpha: r
    })
  ...
  u.start = function () {
    function t(t, r) {
      for (var i, o = e(n), a = - 1, u = o.length; u > ++a; ) if (!isNaN(i = o[a][t])) return i;
    ...
    function e() {
      if (!s) {
        ...
        for (r = 0; g > r; ++r) {
          var t = v[r];
          s[t.source.index].push(t.target),
          s[t.target.index].push(t.source)
        }
      }
      return s[n]
    }
    ...
    y = c[0],
    x = c[1];
    for (n = 0; p > n; ++n) (l = m[n]).index = n,
    l.weight = 0;
    for (n = 0; g > n; ++n) l = v[n],
    'number' == typeof l.source && (l.source = m[l.source]),
    'number' == typeof l.target && (l.target = m[l.target]),
    ++l.source.weight,
    ++l.target.weight;
    for (n = 0; p > n; ++n) l = m[n],
    isNaN(l.x) && (l.x = t('x', y)),
    ...
    isNaN(l.py) && (l.py = l.y);
    if (i = [
    ], 'function' == typeof f) for (n = 0; g > n; ++n) i[n] = + f.call(this, v[n], n);
     else for (n = 0; g > n; ++n) i[n] = f;
    if (o = [
    ], 'function' == typeof h) for (n = 0; g > n; ++n) o[n] = + h.call(this, v[n], n);
     else for (n = 0; g > n; ++n) o[n] = h;
    if (a = [
    ], 'function' == typeof d) for (n = 0; p > n; ++n) a[n] = + d.call(this, m[n], n);
     else for (n = 0; p > n; ++n) a[n] = d;
    return u.resume()
  },
  u.resume = function () {
    return u.alpha(0.1)
  ...
  u.drag = function () {
    return n || (n = ca.behavior.drag().origin(fe).on('dragstart.force', Br).on('drag.force', e).on('dragend.force', Ir)),
    arguments.length ? (this.on('mouseover.force', Wr).on('mouseout.force', Ur).call(n), void 0)  : n
  },
  ca.rebind(u, s, 'on')
};
var Iu = 20,
...
ca.layout.hierarchy = function () {
  function t(e, a, u) {
    ...
    if (e.depth = a, u.push(e), s && (c = s.length)) {
      for (var c, l, f = - 1, h = e.children = [
      ], d = 0, p = a + 1; c > ++f; ) l = t(s[f], p, u),
      l.parent = e,
      h.push(l),
      d += l.value;
      r && h.sort(r),
  ...
  function e(t, r) {
    var i = t.children,
    a = 0;
    if (i && (u = i.length)) for (var u, s = - 1, c = r + 1; u > ++s; ) a += e(i[s], c);
...
ca.layout.partition = function () {
  function t(e, n, r, i) {
    ...
    if (e.x = n, e.y = e.depth * i, e.dx = r, e.dy = i, o && (a = o.length)) {
      ...
      s,
      c = - 1;
      for (r = e.value ? r / e.value : 0; a > ++c; ) t(u = o[c], n, s = u.value * r, i),
      n += s
    }
  }
  function e(t) {
    var n = t.children,
    r = 0;
    if (n && (i = n.length)) for (var i, o = - 1; i > ++o; ) r = Math.max(r, e(n[o]));
    return 1 + r
  }
  function n(n, o) {
...
var Xu = ca.map({
  'inside-out': function (t) {
    ...
    for (e = 0; r > e; ++e) n = a[e],
    s > u ? (u += o[n], c.push(n))  : (s += o[n], l.push(n));
...
ca.layout.histogram = function () {
  function t(t, o) {
    for (var a, u, s = [
    ], c = t.map(n, this), l = r.call(this, c, o), f = i.call(this, l, c, o), o = - 1, h = c.length, d = f.length - 1, p = e ? 1 : 1 / h; d > ++o; ) a = s[o] = [
    ],
    a.dx = f[o + 1] - (a.x = f[o]),
    a.y = 0;
    if (d > 0) for (o = - 1; h > ++o; ) u = c[o],
    u >= l[0] && l[1] >= u && (a = s[ca.bisect(f, u, 1, d) - 1], a.y += p, a.push(t[o]));
    return s
  }
  var e = !0,
  n = Number,
...
ca.layout.tree = function () {
  function t(t, i) {
    function o(t, e) {
      ...
      i = t._tree;
      if (r && (a = r.length)) {
        for (var a, s, c, l = r[0], f = l, h = - 1; a > ++h; ) c = r[h],
        o(c, s),
        f = u(c, s, f),
        s = c;
        yi(t);
        var d = 0.5 * (l._tree.prelim + c._tree.prelim);
    ...
    function u(t, e, r) {
      if (e) {
        for (var i, o = t, a = t, u = e, s = t.parent.children[0], c = o._tree.mod, l = a._tree.mod, f = u._tree.mod, h = s._tree.mod; u = hi(u), o = fi(o), u && o; ) s = fi(s),
        a = hi(a),
        a._tree.ancestor = t,
        i = u._tree.prelim + f - o._tree.prelim - c + n(u, o),
        i > 0 && (xi(bi(u, t, r), t, i), c += i, l += i),
        f += u._tree.mod,
        c += o._tree.mod,
        h += s._tree.mod,
        l += a._tree.mod;
        u && !hi(a) && (a._tree.thread = u, a._tree.mod += f - l),
        o && !fi(s) && (s._tree.thread = o, s._tree.mod += c - h, r = t)
      }
      return r
    }
...
ca.layout.treemap = function () {
  function t(t, e) {
    for (var n, r, i = - 1, o = t.length; o > ++i; ) r = (n = t[i]).value * (0 > e ? 0 : e),
  ...
  function e(n) {
    ...
    if (o && o.length) {
      ...
      for (t(h, c.dx * c.dy / n.value), l.area = 0; (s = h.length) > 0; ) l.push(a = h[s - 1]),
      l.area += a.area,
      'squarify' !== d || p >= (u = r(l, g)) ? (h.pop(), p = u)  : (l.area -= l.pop().area, i(l, g, c, !1), g = Math.min(c.dx, c.dy), l.length = l.area = 0, p = 1 / 0);
      l.length && (i(l, g, c, !0), l.length = l.area = 0),
      o.forEach(e)
    }
  }
  function n(e) {
    ...
    if (r && r.length) {
      ...
      for (t(u, a.dx * a.dy / e.value), s.area = 0; o = u.pop(); ) s.push(o),
      s.area += o.area,
      null != o.z && (i(s, o.z ? a.dx : a.dy, a, !u.length), s.length = s.area = 0);
      r.forEach(n)
    }
  }
  function r(t, e) {
    ...
    return r *= r,
    e *= e,
    r ? Math.max(e * i * p / r, r / (e * o * p))  : 1 / 0
  }
  function i(t, e, n, r) {
    var i,
    o = - 1,
    ...
    l = e ? s(t.area / e)  : 0;
    if (e == n.dx) {
      for ((r || l > n.dy) && (l = n.dy); a > ++o; ) i = t[o],
      i.x = u,
      i.y = c,
      i.dy = l,
      u += i.dx = Math.min(n.x + n.dx - u, l ? s(i.area / l)  : 0);
      i.z = !0,
      i.dx += n.x + n.dx - u,
      n.y += l,
      n.dy -= l
    } else {
      for ((r || l > n.dx) && (l = n.dx); a > ++o; ) i = t[o],
      i.x = u,
      i.y = c,
      i.dx = l,
      c += i.dy = Math.min(n.y + n.dy - c, l ? s(i.area / l)  : 0);
      i.z = !1,
      i.dy += n.y + n.dy - c,
      n.x += l,
      n.dx -= l
  ...
  o.padding = function (t) {
    function e(e) {
      ...
      return null == n ? ji(e)  : Fi(e, 'number' == typeof n ? [
        n,
        n,
        n,
        n
    ...
    var r;
    return f = null == (l = t) ? ji : 'function' == (r = typeof t) ? e : 'number' === r ? (t = [
      t,
      t,
      t,
      t
...
ca.scale.log = function () {
  return Xi(ca.scale.linear().domain([0,
  Math.LN10]), 10, Vi, Zi)
};
var Zu = ca.format('.0e');
...
ca.scale.sqrt = function () {
  return ca.scale.pow().exponent(0.5)
},
...
ca.transition.prototype = as,
as.select = function (t) {
  var e,
  n,
  r,
  i = this.id,
...
as.selectAll = function (t) {
  ...
  'function' != typeof t && (t = y(t));
  for (var s = - 1, c = this.length; c > ++s; ) for (var l = this[s], f = - 1, h = l.length; h > ++f; ) if (r = l[f]) {
    o = r.__transition__[a],
    n = t.call(r, r.__data__, f),
    u.push(e = [
    ]);
    for (var d = - 1, p = n.length; p > ++d; ) _o(i = n[d], d, a, o),
    e.push(i)
  }
  return xo(u, a)
},
...
as.attr = function (t, e) {
  ...
  function o(t) {
    return null == t ? r : (t += '', function () {
      var e,
      n = this.getAttributeNS(u.space, u.local);
      return n !== t && (e = a(n, t), function (t) {
...
as.style = function (t, e, n) {
  ...
  function i(e) {
    return null == e ? r : (e += '', function () {
      var r,
      i = fa.getComputedStyle(this, null).getPropertyValue(t);
...
as.each = function (t, e) {
  ...
  if (2 > arguments.length) {
    ...
    i = rs;
    rs = n,
    j(this, function (e, r, i) {
      ss = e.__transition__[n],
...
as.transition = function () {
  for (var t, e, n, r, i = this.id, o = ++us, a = [
  ], u = 0, s = this.length; s > u; u++) {
    a.push(t = [
    ]);
    for (var e = this[u], c = 0, l = e.length; l > c; c++) (n = e[c]) && (r = Object.create(n.__transition__[i]), r.delay += r.duration, _o(n, c, o, r)),
    t.push(n)
  }
  return xo(a, o)
},
ca.svg.axis = function () {
  function t(t) {
    t.each(function () {
      ...
      m = g.enter().insert('line', '.tick').attr('class', 'tick minor').style('opacity', 0.000001),
      v = ca.transition(g.exit()).style('opacity', 0.000001).remove(),
      y = ca.transition(g).style('opacity', 1),
      x = f.selectAll('.tick.major').data(h, String),
      b = x.enter().insert('g', 'path').attr('class', 'tick major').style('opacity', 0.000001),
      M = ca.transition(x.exit()).style('opacity', 0.000001).remove(),
      ...
      switch (r) {
        case 'bottom':
          t = wo,
          m.attr('y2', o),
          y.attr('x2', 0).attr('y2', o),
          N.attr('y2', i),
          D.attr('y', Math.max(i, 0) + u),
          C.attr('x2', 0).attr('y2', i),
          L.attr('x', 0).attr('y', Math.max(i, 0) + u),
          A.attr('dy', '.71em').style('text-anchor', 'middle'),
          T.attr('d', 'M' + w[0] + ',' + a + 'V0H' + w[1] + 'V' + a);
          break;
        case 'top':
          t = wo,
          m.attr('y2', - o),
          ...
          C.attr('x2', 0).attr('y2', - i),
          L.attr('x', 0).attr('y', - (Math.max(i, 0) + u)),
          A.attr('dy', '0em').style('text-anchor', 'middle'),
          T.attr('d', 'M' + w[0] + ',' + - a + 'V0H' + w[1] + 'V' + - a);
          break;
        case 'left':
          t = ko,
          m.attr('x2', - o),
          y.attr('x2', - o).attr('y2', 0),
          N.attr('x2', - i),
          D.attr('x', - (Math.max(i, 0) + u)),
          C.attr('x2', - i).attr('y2', 0),
          L.attr('x', - (Math.max(i, 0) + u)).attr('y', 0),
          A.attr('dy', '.32em').style('text-anchor', 'end'),
          T.attr('d', 'M' + - a + ',' + w[0] + 'H0V' + w[1] + 'H' + - a);
          break;
        case 'right':
          t = ko,
          m.attr('x2', o),
          ...
          C.attr('x2', i).attr('y2', 0),
          L.attr('x', Math.max(i, 0) + u).attr('y', 0),
          A.attr('dy', '.32em').style('text-anchor', 'start'),
          T.attr('d', 'M' + a + ',' + w[0] + 'H0V' + w[1] + 'H' + a)
      }
      if (n.ticks) b.call(t, E),
      _.call(t, S),
      M.call(t, S),
      m.call(t, E),
      y.call(t, S),
...
function t(o) {
  o.each(function () {
    ...
    a.style('pointer-events', 'all').on('mousedown.brush', i).on('touchstart.brush', i),
    c.enter().append('rect').attr('class', 'background').style('visibility', 'hidden').style('cursor', 'crosshair'),
    f.enter().append('rect').attr('class', 'extent').style('cursor', 'move'),
    h.enter().append('g').attr('class', function (t) {
      return 'resize ' + t
    ...
    h.exit().remove(),
    u && (o = Oi(u), c.attr('x', o[0]).attr('width', o[1] - o[0]), n(a)),
    s && (o = Oi(s), c.attr('y', o[0]).attr('height', o[1] - o[0]), r(a)),
    e(a)
  })
}
function e(t) {
...
function r(t) {
  ...
  t.selectAll('.extent,.e>rect,.w>rect').attr('height', f[1][1] - f[0][1])
}
function i() {
  function i() {
  ...
  function d() {
    ...
    o = !1;
    v && (t[0] += v[0], t[1] += v[1]),
    T || (ca.event.altKey ? (m || (m = [
      (f[0][0] + f[1][0]) / 2,
      (f[0][1] + f[1][1]) / 2
    ]), S[0] = f[ + (t[0] < m[0])][0], S[1] = f[ + (t[1] < m[1])][1])  : m = null),
    w && p(t, u, 0) && (n(M), o = !0),
    k && p(t, s, 1) && (r(M), o = !0),
    o && (e(M), b({
      type: 'brush',
  ...
  function p(t, e, n) {
    ...
    l = f[1][n] - f[0][n];
    return T && (u -= c, s -= l + c),
    r = Math.max(u, Math.min(s, t[n])),
    T ? i = (r += c) + l : (m && (c = Math.max(u, Math.min(s, 2 * m[n] - r))), r > c ? (i = r, r = c)  : i = c),
    f[0][n] !== r || f[1][n] !== i ? (o = null, f[0][n] = r, f[1][n] = i, !0)  : void 0
  }
  function g() {
    d(),
    M.style('pointer-events', 'all').selectAll('.resize').style('display', t.empty() ? 'none' : null),
  ...
  M.style('pointer-events', 'none').selectAll('.resize').style('display', null),
  ca.select('body').style('cursor', x.style('cursor')),
  b({
    type: 'brushstart'
  }),
  d(),
...
var o,
a = h(t, 'brushstart', 'brush', 'brushend'),
u = null,
s = null,
l = hs[0],
f = [
...
ca.time.dayOfYear = function (t) {
var e = ca.time.year(t);
return Math.floor((t - e - 60000 * (t.getTimezoneOffset() - e.getTimezoneOffset())) / 86400000)
},
ps.forEach(function (t, e) {
t = t.toLowerCase(),
e = 7 - e;
var n = ca.time[t] = Eo(function (t) {
  return (t = ca.time.day(t)).setDate(t.getDate() - (t.getDay() + e) % 7),
  t
}, function (t, e) {
...
ca.time[t + 's'] = n.range,
ca.time[t + 's'].utc = n.utc.range,
ca.time[t + 'OfYear'] = function (t) {
  var n = ca.time.year(t).getDay();
...
ca.time.format = function (t) {
function e(e) {
  for (var r, i, o, a = [
  ], u = - 1, s = 0; n > ++u; ) 37 === t.charCodeAt(u) && (a.push(t.substring(s, u)), null != (i = Cs[r = t.charAt(++u)]) && (r = t.charAt(++u)), (o = As[r]) && (r = o(e, null == i ? 'e' === r ? ' ' : '0' : i)), a.push(r), s = u + 1);
  return a.push(t.substring(s, u)),
  a.join('')
}
var n = t.length;
...
Y: function (t, e) {
  return Lo(t.getFullYear() % 10000, e, 4)
},
Z: Go,
'%': function () {
  return '%'
...
ca.time.format.iso = Date.prototype.toISOString && + new Date('2000-01-01T00:00:00.000Z') ? Jo : js,
Jo.parse = function (t) {
var e = new Date(t);
return isNaN(e) ? null : e
},
Jo.toString = js.toString,
ca.time.second = Eo(function (t) {
return new ds(1000 * Math.floor(t / 1000))
}, function (t, e) {
t.setTime(t.getTime() + 1000 * Math.floor(e))
}, function (t) {
return t.getSeconds()
}),
ca.time.seconds = ca.time.second.range,
ca.time.seconds.utc = ca.time.second.utc.range,
ca.time.minute = Eo(function (t) {
return new ds(60000 * Math.floor(t / 60000))
}, function (t, e) {
t.setTime(t.getTime() + 60000 * Math.floor(e))
}, function (t) {
return t.getMinutes()
}),
ca.time.minutes = ca.time.minute.range,
ca.time.minutes.utc = ca.time.minute.utc.range,
ca.time.hour = Eo(function (t) {
var e = t.getTimezoneOffset() / 60;
return new ds(3600000 * (Math.floor(t / 3600000 - e) + e))
}, function (t, e) {
t.setTime(t.getTime() + 3600000 * Math.floor(e))
}, function (t) {
return t.getHours()
}),
ca.time.hours = ca.time.hour.range,
ca.time.hours.utc = ca.time.hour.utc.range,
ca.time.month = Eo(function (t) {
return t = ca.time.day(t),
t.setDate(1),
t
}, function (t, e) {
...
Rs = [
[ca.time.format.utc('%Y'),
je],
[
  ca.time.format.utc('%B'),
  function (t) {
    return t.getUTCMonth()
  }
],
[
  ca.time.format.utc('%b %d'),
  function (t) {
    return 1 != t.getUTCDate()
  }
],
[
  ca.time.format.utc('%a %d'),
  function (t) {
    return t.getUTCDay() && 1 != t.getUTCDate()
  }
],
[
  ca.time.format.utc('%I %p'),
  function (t) {
    return t.getUTCHours()
  }
],
[
  ca.time.format.utc('%I:%M'),
  function (t) {
    return t.getUTCMinutes()
  }
],
[
  ca.time.format.utc(':%S'),
  function (t) {
    return t.getUTCSeconds()
  }
],
[
  ca.time.format.utc('.%L'),
  function (t) {
...
this._milliseconds = l + 1000 * c + 60000 * s + 3600000 * a,
this._days = o + 7 * i,
this._months = r + 12 * n,
e.milliseconds = l % 1000,
c += u(l / 1000),
e.seconds = c % 60,
s += u(c / 60),
e.minutes = s % 60,
...
o = e._days,
a = e._months;
i && t._d.setTime( + t + i * n),
o && t.date(t.date() + o * n),
a && (r = t.date(), t.date(1).month(t.month() + a * n).date(Math.min(r, t.daysInMonth())))
}
function l(t) {
...
switch (t) {
  ...
  case 'MMM':
  case 'MMMM':
    r = d(n._l).monthsParse(e),
    null != r ? i[1] = r : n._isValid = !1;
    break;
  case 'D':
  case 'DD':
  case 'DDD':
...
if (!t._d) {
  ...
  r[4] += t._tzm || 0,
  n = new Date(0),
  t._useUTC ? (n.setUTCFullYear(r[0], r[1], r[2]), n.setUTCHours(r[3], r[4], r[5], r[6]))  : (n.setFullYear(r[0], r[1], r[2]), n.setHours(r[3], r[4], r[5], r[6])),
  t._d = n
}
}
function b(t) {
...
i = t._i;
for (t._a = [
], e = 0; r.length > e; e++) n = (v(r[e]).exec(i) || []) [0],
...
for (var e, n, r, o, u = 99; t._f.length; ) {
  if (e = a({
  }, t), e._f = t._f.pop(), b(e), n = new i(e), n.isValid()) {
    r = n;
    break
  }
  o = f(e._a, n.toArray()),
...
n = t._i;
if (Z.exec(n)) {
  for (t._f = 'YYYY-MM-DDT', e = 0; 4 > e; e++) if (J[e][1].exec(n)) {
    t._f += J[e][0];
    break
  }
  U.exec(n) && (t._f += ' Z'),
...
return i > r && (i -= 7),
r - 7 > i && (i += 7),
Math.ceil(D(t).add('d', i).dayOfYear() / 7)
}
function E(t) {
var e = t._i,
n = t._f;
return null === e || '' === e ? null : ('string' == typeof e && (t._i = e = d().preparse(e)), D.isMoment(e) ? (t = a({
}, e), t._d = new Date( + e._d))  : n ? l(n) ? M(t)  : b(t)  : w(t), new i(t))
}
function N(t, e) {
...
for (var D, L, H = '2.0.0', j = Math.round, F = {
...
}, ne = 'DDD w W M D d'.split(' '), re = 'M D H h m s w W'.split(' '), ie = {
M: function () {
  return this.month() + 1
},
MMM: function (t) {
...
monthsParse: function (t) {
  ...
  ]), e = 0; 12 > e; e++) if (this._monthsParse[e] || (n = D([2000,
  e]), r = '^' + this.months(n, '') + '|^' + this.monthsShort(n, ''), this._monthsParse[e] = RegExp(r.replace('.', ''), 'i')), this._monthsParse[e].test(t)) return e
},
...
a = r ? t._data : i ? {
 ...
 : t;
return i && (e ? a[e] = t : a.milliseconds = t),
n = new o(a),
...
isValid: function () {
  return null == this._isValid && (this._isValid = this._a ? !f(this._a, (this._isUTC ? D.utc(this._a)  : D(this._a)).toArray())  : !isNaN(this._d.getTime())),
  !!this._isValid
},
utc: function () {
...
add: function (t, e) {
  var n;
  return n = 'string' == typeof t ? D.duration( + e, t)  : D.duration(t, e),
  c(this, n, 1),
  this
},
...
diff: function (t, e, n) {
  var r,
  i,
  o = this._isUTC ? D(t).utc()  : D(t).local(),
  a = 60000 * (this.zone() - o.zone());
  return e && (e = e.replace(/s$/, '')),
  'year' === e || 'month' === e ? (r = 43200000 * (this.daysInMonth() + o.daysInMonth()), i = 12 * (this.year() - o.year()) + (this.month() - o.month()), i += (this - D(this).startOf('month') - (o - D(o).startOf('month'))) / r, 'year' === e && (i /= 12))  : (r = this - o - a, i = 'second' === e ? r / 1000 : 'minute' === e ? r / 60000 : 'hour' === e ? r / 3600000 : 'day' === e ? r / 86400000 : 'week' === e ? r / 604800000 : r),
  n ? i : u(i)
},
from: function (t, e) {
...
isDST: function () {
  return this.zone() < D([this.year()]).zone() || this.zone() < D([this.year(),
  5]).zone()
},
day: function (t) {
...
isAfter: function (t, e) {
  return e = e !== void 0 ? e : 'millisecond',
  + this.clone().startOf(e) > + D(t).startOf(e)
},
...
daysInMonth: function () {
  return D.utc([this.year(),
  this.month() + 1,
  0]).date()
},
dayOfYear: function (t) {
  var e = j((D(this).startOf('day') - D(this).startOf('year')) / 86400000) + 1;
...
L = 0;
Q.length > L;
L++) N(Q[L].toLowerCase().replace(/s$/, ''), Q[L]); N('year', 'FullYear'), D.fn.days = D.fn.day, D.fn.weeks = D.fn.week, D.fn.isoWeeks = D.fn.isoWeek, D.duration.fn = o.prototype = {
weeks: function () {
  return u(this.days() / 7)
},
valueOf: function () {
  return this._milliseconds + 86400000 * this._days + 2592000000 * this._months
},
humanize: function (t) {
  var e = + this,
  n = T(e, !t, this.lang());
...
lang: D.fn.lang
}; for (L in te) te.hasOwnProperty(L) && (A(L, te[L]), C(L.toLowerCase())); A('Weeks', 604800000), D.lang('en', {
ordinal: function (t) {
  var e = t % 10,
  n = 1 === ~~(t % 100 / 10) ? 'th' : 1 === e ? 'st' : 2 === e ? 'nd' : 3 === e ? 'rd' : 'th';
  return t + n
}
}), q && (module.exports = D), 'undefined' == typeof ender && (this.moment = D), 'function' == typeof define && define.amd && define('moment', [
], function () {
return D
})
}.call(this),
...
return t += ' a modern browser like ',
t += ' <a href=\'http://windows.microsoft.com/en-GB/internet-explorer/download-ie\'>Internet Explorer 9/10</a>, ',
t += ' <a href=\'http://www.google.com/chrome\'>Chrome</a>,',
t += ' <a href=\'http://www.mozilla.org/en-US/firefox/new/\'>Firefox</a>,',
t += ' or <a href=\'https://www.apple.com/safari/\'>Safari</a>.',
$('#vis').html(t),
$('.about').hide(),
!1
}
...
d3.json('/data/raw/E0.json', function (t, l) {
function f(t) {
  $('.option').off(),
  $('.ranking').off(),
  $('.previous, .next').off();
  ...
  y]).range([o.left,
  a - o.right]),
  y_points = d3.scale.linear().domain([0,
  b]).range([u - 20,
  o.top]),
  y_position = d3.scale.linear().domain([m,
  0]).range([u - 20,
  o.top]);
  ...
  w.enter().append('g').attr('class', 'x axis').attr('transform', 'translate(0,' + (u - 20) + ')').append('text').attr('x', a / 2).attr('dy', '3em').text('Games played'),
  k.enter().append('g').attr('class', 'y axis').attr('transform', 'translate(' + o.left + ',0)').append('text').attr('class', 'yAxisLabel').attr('y', 0).attr('dy', '1em').style('text-anchor', 'middle'),
  s.select('.x.axis').call(M),
  s.select('.y.axis').transition().duration(1000).call(_),
  s.select('.y.axis').select('text.yAxisLabel').text(function () {
  ...
  S = function (t) {
    var e = d3.scale.quantile().domain([0,
    1]).range(d3.range(1, y + 1));
    return function (n) {
  ...
  N.append('rect').attr('class', function (t) {
    ...
    return t.position[t.position.length - 1] !== void 0 ? y_position(t.position[t.position.length - 1]) - 10 : - 10000
  }).attr('rx', 4).attr('ry', 4).attr('width', o.right + 5).attr('height', 20),
  N.append('text').attr('class', function (t) {
    return t.code + ' legend'
  }).attr('x', a - o.left - o.right + 50).attr('y', function (t) {
    return t.position[t.position.length - 1] !== void 0 ? y_position(t.position[t.position.length - 1]) + 3 : - 10000
  }).attr('opacity', 0).attr('dy', '.2em').text(function (t) {
    return t.name
  });
  var C = E.selectAll('circle.match').data(function (t) {
    for (var e = [
    ], n = 0; t.points.length > n; n++) {
      var r = {
        points: t.points[n],
  ...
  E.selectAll('circle.match').transition().duration(300).attr('cx', function (t, e) {
    ...
    return g ? y_points(t.points)  : t.position !== void 0 ? y_position(t.position)  : - 1000
  }).attr('opacity', 0.8),
  C.enter().append('circle').attr('class', function (t) {
    return t.code + ' match'
  ...
  t ? (A.transition().duration(1000).attrTween('d', function (t) {
  ...
  }), D.transition().duration(1000).attrTween('d', function (t) {
    return g ? S(t.points)  : S(t.position)
  }).each('end', function () {
    d3.select(this).on('mouseover', function (t) {
      highlightPath(t.code)
  ...
  }))  : (A.on('mouseover', null).on('mouseout', null).transition().duration(1000).attr('d', function (t) {
  ...
  }), D.on('mouseover', null).on('mouseout', null).transition().duration(1000).attr('d', function (t) {
    return g ? T(t.points)  : T(t.position)
  }).attr('class', function (t) {
    return 'inner ' + t.code
  }).each('end', function () {
  ...
  E.selectAll('circle.match').on('mouseover', null).on('mouseout', null).transition().duration(function (e, n) {
    return t ? n * (2000 / y)  : 1000
  }).attr('cx', function (t, e) {
    return x(e + 1)
  }).attr('cy', function (t) {
    return g ? y_points(t.points)  : t.position !== void 0 ? y_position(t.position)  : - 1000
  }).attr('opacity', 0.8).each('end', function () {
    d3.select(this).on('mouseover', function (t) {
      if (highlightPath(t.code), - 1 == t.id) var e = 'Start of season';
        ...
        e += n.FTHG === n.FTAG ? 'Drew with ' : n.FTHG > n.FTAG ? r ? 'Beat ' : 'Lost to ' : r ? 'Lost to ' : 'Beat ',
        e += r ? n.awayteam : n.hometeam,
        e += ' ' + n.FTHG + '-' + n.FTAG + '<br/>'
      }
      if (t.gameno + 1 === y) {
        var i = parseInt(t.position) + 1;
        e += 'Ended season ' + ordinal_suffix_of(i),
        e += '<br/>with ' + t.points + ' points'
      } else e += t.points + ' points',
      t.position !== void 0 && (e += ', position ' + (t.position + 1));
      ...
      c.transition().duration(100).style('opacity', 0.9),
      c.style('left', o + 'px').style('top', a + 'px')
    }).on('mouseout', function (t) {
      unHighlightPath(t.code),
      d3.select('.tooltip').transition().duration(100).style('opacity', 0.000001)
    })
  }),
  C.exit().remove(),
  L.on('mouseover', null).on('mouseout', null).transition().duration(1000).attr('y', function (t) {
    return t.position[t.position.length - 1] !== void 0 ? y_position(t.position[t.position.length - 1]) + 3 : - 10000
  }).attr('opacity', 0.9).each('end', function () {
    d3.select(this).on('mouseover', function (t) {
      highlightPath(t.code)
    }).on('mouseout', function (t) {
      unHighlightPath(t.code)
  ...
  H.on('mouseover', null).on('mouseout', null).transition().duration(1000).attr('y', function (t) {
    return t.position[t.position.length - 1] !== void 0 ? y_position(t.position[t.position.length - 1]) - 10 : - 10000
  }).attr('opacity', 0.3).each('end', function () {
    d3.select(this).on('mouseover', function (t) {
      highlightPath(t.code)
    }).on('mouseout', function (t) {
      unHighlightPath(t.code)
  ...
  E.exit().transition().duration(1000).attr('transform', function (t) {
    var e = t.position[t.position.length - 1],
    r = e > 10 || 'E0' === n ? 1.5 * u : - 1000;
    return 'translate(0,' + r + ')'
  }),
  E.exit().transition().delay(1000).remove(),
  setTimeout(function () {
    h()
  }, 1100),
  r = e,
...
function h() {
  ...
  $('.previous, .next').click(function (t) {
    ...
    r === n ? $('#next').fadeTo(500, 0)  : r === e ? $('#prev').fadeTo(500, 0)  : ($('#next').fadeTo(500, 1), $('#prev').fadeTo(500, 1)),
    $('#year').data('year', r),
    showYear(),
    f(!1)
  })
